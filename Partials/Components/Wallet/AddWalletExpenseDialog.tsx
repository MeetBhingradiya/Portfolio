...
interface AddWalletExpenseDialogProps {
    open: boolean;
    onClose: () => void;
    onExpenseAdded: () => void;
    userID: string;
...
const AddWalletExpenseDialog: React.FC<AddWalletExpenseDialogProps> = ({ 
    open, 
    onClose, 
    onExpenseAdded, 
    userID 
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await Axios.post('/api/wallet-transactions', expenseData);
                ...
                <ModalBody>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Select
                            ...
                            description={selectedWallet ? `Balance: ${formatCurrency(selectedWallet.Balance)}` : ''}
                        >
                            {wallets.map((wallet) => (
...
export default AddWalletExpenseDialog;
