...
function validateHsva(value: string): ValidationResult {
    ...
    const hsvaRegex =
        /^hsva?\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%(?:\s*,\s*([0-9.]+))?\s*\)$/;
...
export default function ColourConverter() {
    ...
    const [isDraggingSaturation, setIsDraggingSaturation] =
    ...
    return (
        <div className="Page ColourConverter">
            ...
            <p className="description">
                Convert colours between different formats with real-time preview
            </p>
                        ...
                        <div className="format-item">
                            <div className="format-label">
                                ...
                                <span
                                    className="copy-button"
                                    onClick={() =>
                                        copyToClipboard(`--color: ${hexValue};`)
                                    }
                                    title="Copy to clipboard">
                                    <ContentCopy fontSize="small" />
                                </span>
