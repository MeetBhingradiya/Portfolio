        ...
        <MotionCard
                ...
                <div className="flex items-center gap-2 justify-start">
                    <div className="w-10 h-10 flex items-center justify-center rounded-md overflow-hidden">
                        ...
                        typeof Data.Icon === "string" ? (
                            <div
                                ...
                                <SvgComponent svgString={Data.Icon} />
                            </div>
                        ) : Data.Icon ? (
                            <img
                                ...
                                onError={(e) => {
                                    (e.target as HTMLImageElement).src =
                                        "https://img.icons8.com/fluency/48/bookmark-ribbon.png";
                                }}
                            />
                        ) : (
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-xs justify-start flex text-gray-500 truncate max-w-[200px]">
                            {Data.isAdminOnly === true && !isAdmin
                                ? "Access Denied"
                                : Data?.WebLink || "No URL provided"}
                        </div>
                    </div>
                </div>
            ...
            Data.isCloudSync ? (
                <div className="flex justify-start gap-2 items-center mt-2 w-full px-2">
                    {Data.Windows && (
                        <Tooltip
                            content={"Contains Windows App Link"}
                            placement="top">
                            <div
                                className={cn(
                    ...
                    {Data.Android && (
                        <Tooltip
                            content={"Contains Android App Link"}
                            placement="top">
                            <div
                                className={cn(
                                    "flex items-center justify-center rounded-full p-[1px]",
                    ...
                    {Data.isDeleteBlock && (
                        <Tooltip
                            content="you can't edit this bookmark"
                            placement="top">
                            <div
                                className={cn(
                                    "flex items-center justify-center rounded-full p-[1px]",
                    ...
                    {Data.isDeleteBlock && (
                        <Tooltip
                            content="you can't remove this without factory reset"
                            placement="top">
                            <div
                                className={cn(
                                    "flex items-center justify-center rounded-full p-[1px]",
