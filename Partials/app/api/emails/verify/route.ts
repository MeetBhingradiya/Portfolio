...
// Email verification endpoints disabled - incompatible with new user schema
// The new schema uses a single email field instead of Emails array
// and doesn't have Credentials array for encryption

export async function POST(request: NextRequest) {
    return NextResponse.json(
        {
            Status: 0,
            Message: "Email verification is temporarily disabled. Please contact support.",
            StatusCode: 501
        },
        { status: 501 }
    );
...
/* Original code - requires schema refactor
