				...
				<NavbarContent justify="end" className="gap-2">
					...
					<NavbarItem>
						<Dropdown placement="bottom-end">
							...
							>
								...
								<DropdownItem key="notification1" textValue="New blog post published">
									<div className="flex flex-col gap-1">
										<p className="font-medium">New blog post published</p>
										<p className="text-xs text-foreground-500">
											&quot;Getting Started with Next.js&quot; is now live
										</p>
									</div>
								</DropdownItem>
								<DropdownItem key="notification2" textValue="Support ticket created">
									<div className="flex flex-col gap-1">
						...
						<Dropdown placement="bottom-end">
							...
							<DropdownMenu aria-label="Help">
								...
								<DropdownItem
									...
									onClick={() => router.push("/admin/bug-report")}
								>
									Report Bug
								</DropdownItem>
							</DropdownMenu>
					...
					<NavbarItem>
						<Dropdown placement="bottom-end">
							<DropdownTrigger>
								<Avatar
									src={currentAccount?.profileData?.profilePicture}
