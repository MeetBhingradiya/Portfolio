...
export default function HeadNavigation() {
    ...
    const activeNotifications = useMemo(() => {
        ...
        const dismissedValue = typeof window !== "undefined" ? localStorage.getItem("Notification_Dismissed") : null;
        ...
        const handleScroll = () => {
            ...
            if (isScrolled !== scrolledRef.current) {
                ...
                if (isApple) {
                    ...
                    if (glassReflectionRef.current) glassReflectionRef.current.style.height = isScrolled ? "60%" : "50%";
                }
            }
        };
        ...
        <>
            ...
            <AnimatePresence>
                {activeNotifications.map((notification, index) => {
                    ...
                    const uniqueKey = notification.storageValue
                        ? `notification-${notification.storageValue}`
                        : `notification-${index}-${notification.message.substring(0, 20)}`;
                        ...
                        <motion.div
                            ...
                            <div className="max-w-7xl mx-auto px-4 md:px-6 py-3.5 pb-4">
                                <div
                                    ...
                                    style={{
                                        justifyContent: notification.dismissible ? "space-between" : "flex-start"
                                    }}>
                                    <div
                                        className="flex items-center gap-3.5"
                                        style={{
                                            maxWidth: notification.dismissible ? "calc(100% - 56px)" : "100%"
                                        }}>
                                        <motion.div
                                        ...
                                        {notification.link && (
                                            <Link href={notification.link.href}>
                                                <motion.span
                                                    ...
                                                    <span className="relative z-10">{notification.link.text} →</span>
                                                </motion.span>
                                            </Link>
                                        )}
                                    </div>
                            ...
                            {menuCategories.map((category) => (
                                <div
                                    ...
                                    <motion.button
                                        ...
                                        style={{
                                            color: activeMenu === category.label ? palette.accent : palette.textSecondary,
                                            background:
                                        ...
                                        <KeyboardArrowDown
                                            ...
                                            style={{
                                                transform: activeMenu === category.label ? "rotate(180deg)" : "rotate(0deg)",
                                    ...
                                    <motion.button
                                        ...
                                        {user?.image ? (
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    background: generateAvatarGradient(user?.id || "default")
                                                }}>
                                                ...
                                                <div className={`${isApple ? "p-2.5" : "p-3"} relative z-10`}>
                                                    ...
                                                    <Link href="/settings/profile">
                                                        <motion.div
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                <div
                                                                    className={`${isApple ? "text-sm font-semibold" : "text-sm font-bold"} truncate`}
                                                                    style={{
                                                                        color: palette.textPrimary
                                                                    }}>
                                                                    {user?.name || "User"}
                                                    ...
                                                    <div
                                                        className={`${isApple ? "my-2 mx-3" : "my-2.5 mx-4"} h-px`}
                                                        style={{
                            ...
                            <div className="p-5 space-y-5">
                                ...
                                {isAuthenticated && (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{
                                            delay: menuCategories.length * 0.1
                                        }}>
                                        <div
                                            className={`${isApple ? "text-xs font-semibold" : "text-xs font-black"} uppercase tracking-[0.15em]`}
                                            style={{
                                        ...
                                        <div
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div
                                                    className={`${isApple ? "font-semibold" : "font-black"} truncate`}
                                                    style={{
                                                        color: palette.textPrimary
                                                    }}>
                                                    {user?.name || "User"}
                                        ...
                                        {[
                                            ...
                                            },
                                            {
                                                label: "Profile",
                                                href: "/settings/profile",
                                                icon: <AccountCircle className="text-xl" />
                                            },
                                            ...(hasImmichAccess
                                                ? [
                                                      {
                                                          label: "Photos",
                                                          href: "/api/photos",
                                                          icon: <PhotoCamera className="text-xl" />
                                                      }
                                                  ]
                                                : []),
                                            ...(canAccessAdmin
                                                ? [
                                                      {
                                                          ...
                                                          href: "/admin",
                                                          icon: <AdminPanelSettings className="text-xl" />
                                                      }
                                                  ]
                                                : [])
                                        ].map((item) => (
