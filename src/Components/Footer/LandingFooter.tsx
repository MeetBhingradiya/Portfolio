    ...
    const Links: Group[] = [
        ...
        // },
        {
            ...
            links: [
                ...
                {
                    tooltip:
                        "Python, Multi-Threaded, Batch Convert, Customizable",
                    label: "Embroidery DST to PNG",
                    endpoint:
                        "https://github.com/MeetBhingradiya/Embroidery-DST-to-PNG",
                    isEnable: true
                },
                {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <motion.div
                            ...
                            <p className="text-gray-300 mb-6 leading-relaxed">
                                Self-taught developer passionate about creating
                                innovative solutions and contributing to open
                                source. Currently pursuing Diploma in IT and
                        ...
                        {/* Links Sections */}
                        {Links.filter((group) => group.isEnable !== false).map(
                            (group, groupIndex) => (
                                <motion.div
                                    key={groupIndex}
                    ...
                    <motion.div
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                            ...
                            <div className="flex items-center space-x-4 text-gray-400 text-sm">
                                ...
                                {/* Theme Toggle */}
                                <Tooltip
                                    content={`Switch to ${theme === "dark" ? "light" : theme === "light" ? "system" : "dark"} mode`}
                                    placement="top">
                                    <div
