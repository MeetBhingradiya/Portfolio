...
const blogPosts: BlogPost[] = [
    {
        ...
        excerpt: "Exploring how geographical location creates artificial barriers for skilled developers, despite the tech industry's move toward remote work.",
        content: "A deep dive into the challenges skilled developers face when location bias overshadows demonstrable technical capabilities...",
    ...
    },
    {
        ...
        excerpt: "My journey through AI coding tools - from Tabnine to Cursor, Windsurf, and back to Copilot. What works and what doesn't.",
        content: "An in-depth comparison of AI development tools and how they've shaped my workflow over 3+ years...",
    ...
    },
    {
        ...
        excerpt: "How I built a production-grade security platform with advanced threat detection, rate limiting, and monitoring systems.",
        content: "A technical deep-dive into building security systems that can handle enterprise-scale threats...",
    ...
    },
    {
        ...
        excerpt: "Lessons learned from building commercial automation software with advanced session management and detection avoidance.",
        content: "Technical insights into building automation systems that can operate at scale...",
    ...
    },
    {
        ...
        excerpt: "From idea to published package - how I built and published an Express.js enhancement library with TypeScript support.",
        content: "A complete guide to developing, testing, and publishing NPM packages...",
    ...
    },
    {
        ...
        excerpt: "How I went from manual coding to building enterprise systems in 3 years, reaching Staff Engineer level skills through focused learning.",
        content: "My complete journey from beginner to advanced developer, including challenges and breakthroughs...",
...
const categories = ["All", "Technology", "Security", "Development", "Career Insights"];
const popularTags = ["AI", "Security", "Career", "Development Tools", "Architecture", "Remote Work"];
...
function BlogsSection() {
    ...
    const getCategoryIcon = (category: string) => {
        switch (category) {
            case "Technology": return <Code className="text-sm" />;
            case "Security": return <Security className="text-sm" />;
            case "Development": return <Build className="text-sm" />;
            case "Career Insights": return <School className="text-sm" />;
            default: return <Article className="text-sm" />;
        }
    };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                        Insights on software engineering, security, automation, and the tech industry from a Staff Engineer perspective.
                    </p>
                </motion.div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-gray-600 dark:text-gray-400">
                                {selectedTags.length > 0 ? `${selectedTags.length} tags selected` : "No filters"}
                            </span>
                        </div>
                    </div>
