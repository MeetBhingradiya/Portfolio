...
function useGlass(isDark: boolean, isApple: boolean): React.CSSProperties {
    return {
        ...
        boxShadow: isApple ? (isDark ? "0 8px 32px rgba(0,0,0,0.4)" : "0 4px 24px rgba(0,0,0,0.1)") : "none"
    };
}
...
function CopyButton({ text, label = "Copy" }: { text: string; label?: string }) {
    ...
    return (
        <button
            ...
            style={{
                background: copied ? "#30D15820" : `${isDark(palette) ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.06)"}`,
                color: copied ? "#30D158" : palette.textTertiary
            }}>
...
function isDark(palette: any) {
    return palette?.bg?.includes?.("28,28") || false;
}
        ...
        <div className="flex flex-wrap gap-2">
            {tags.map((t) => (
                <span
                    ...
                    style={{
                        background: isDark(palette) ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.05)",
                ...
                {screenshots.length > 1 && (
                    <>
                        <button
                            ...
                            style={{
                                background: isDarkMode ? "rgba(0,0,0,0.55)" : "rgba(255,255,255,0.8)"
                            }}>
                        ...
                        <span
                            className="absolute bottom-3 right-3 text-xs px-2 py-0.5 rounded-full font-semibold"
                            style={{
        ...
        <div>
            ...
            <motion.div
                ...
                <div
                    ...
                    <div
                        className="flex-1 mx-4 flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs"
                        style={{
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    <motion.div
                        ...
                        />
                        <h1
                            className={isApple ? "text-3xl font-bold mt-2 mb-3" : "text-4xl font-black mt-2 mb-3"}
    ...
    return (
        <div>
            ...
            <motion.div
                ...
                />
                <h1
                    className={isApple ? "text-4xl font-bold mt-3 mb-4" : "text-5xl font-black mt-3 mb-4"}
                    style={{ color: palette.textPrimary }}>
                    {project.Title}
                </h1>
                <p
                        ...
                        {allImages.length > 1 && (
                            <>
                                <button
                                    ...
                                    style={{
                                        background: isDarkMode ? "rgba(0,0,0,0.6)" : "rgba(255,255,255,0.85)",
                                ...
                                <span
                                    className="absolute bottom-3 right-3 text-xs px-2.5 py-1 rounded-full font-semibold"
                                    style={{
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="shrink-0">
                        <div
                            ...
                            style={{
                                background: `linear-gradient(135deg, ${accentColor}cc 0%, ${accentColor}80 100%)`,
                            ...
                            {project.Links.chromeWebstore && (
                                <a
                                    ...
                                    style={{
                                        background: CWS_BLUE,
                                        color: "#fff",
                                        boxShadow: `0 4px 16px ${CWS_BLUE}50`
                                    }}>
                            ...
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {featureHighlights.map((feat, i) => {
                                    ...
                                    return (
                                        <div
                                            key={i}
                                            className={`flex flex-col gap-2 p-4 ${isApple ? "rounded-2xl" : "rounded-2xl"}`}
                                            style={{
                                                background: isDarkMode ? "rgba(255,255,255,0.04)" : "rgba(0,0,0,0.03)",
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <InfoRow
                                ...
                                <span
                                    ...
                                    style={{
                                        background: project.Status === "active" ? "#30D15820" : "#FF9F0A20",
                                        color: project.Status === "active" ? "#30D158" : "#FF9F0A"
                                    }}>
                            ...
                            {project.StartDate && (
                                <InfoRow
                                    label="Published"
                                    value={new Date(project.StartDate).toLocaleDateString("en-IN", {
                                        month: "short",
                                        year: "numeric"
                                    })}
                                    palette={palette}
                            ...
                            {project.EndDate && (
                                <InfoRow
                                    label="Updated"
                                    value={new Date(project.EndDate).toLocaleDateString("en-IN", {
                                        month: "short",
                                        year: "numeric"
                                    })}
                                    palette={palette}
                                    ...
                                    {links.map((l, i) => (
                                        <a
                                            ...
                                            style={{
                                                ...
                                                border:
                                                    i !== 0
                                                        ? `1px solid ${isDarkMode ? "rgba(255,255,255,0.09)" : "rgba(0,0,0,0.09)"}`
                                                        : "none"
                                            }}>
                                            {l.icon}
                                            {l.label}
        ...
        <div>
            ...
            <motion.div
                ...
                <div
                    ...
                    style={{
                        background: isDarkMode ? "rgba(203,56,55,0.18)" : "rgba(203,56,55,0.1)",
                        borderColor: isDarkMode ? "rgba(203,56,55,0.3)" : "rgba(203,56,55,0.2)"
                    }}>
                    ...
                    {project.Stats.npmDownloads != null && (
                        <div className="ml-auto text-right">
                            <p
                                className="text-2xl font-black"
                                style={{ color: "#CB3837" }}>
                                {fmt(project.Stats.npmDownloads)}
                            </p>
                            <p
                                className="text-xs"
                                style={{ color: palette.textTertiary }}>
            ...
            <motion.div
                ...
                <div className="flex gap-5 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <h1
                            className={isApple ? "text-2xl font-bold mb-1" : "text-3xl font-black mb-1"}
                            style={{ color: palette.textPrimary }}>
                            {project.Title}
                        </h1>
                        {project.Category && (
    ...
    return (
        <div>
            ...
            <motion.div
                ...
                />
                <h1
                    className={isApple ? "text-3xl md:text-4xl font-bold mt-3 mb-4" : "text-4xl md:text-5xl font-black mt-3 mb-4"}
                    style={{ color: palette.textPrimary }}>
                    {project.Title}
                </h1>
            </motion.div>
                ...
                <div className="lg:col-span-2 flex flex-col gap-7">
                    ...
                    {project.Screenshots.length > 1 && (
                        <motion.div
                            ...
                            />
                            <ScreenshotsGallery
                                screenshots={project.Screenshots.slice(1)}
                                palette={palette}
                                isDarkMode={isDarkMode}
                                isApple={isApple}
                            />
...
function buildProjectLinks(project: Project) {
    return LINK_META.filter((e) => !!project.Links[e.key]).map((e) => ({
        href: project.Links[e.key]!,
        label: e.label,
        icon: e.icon
    }));
}
                ...
                <div className="flex flex-col gap-3">
                    <InfoRow
                        ...
                        <span
                            ...
                            style={{
                                background:
                                    project.Status === "active" ? "#30D15820" : project.Status === "wip" ? "#FF9F0A20" : "#8E8E9320",
                                color: project.Status === "active" ? "#30D158" : project.Status === "wip" ? "#FF9F0A" : "#8E8E93"
                            }}>
...
function SectionLabel({ label, palette, isApple }: { label: string; palette: any; isApple: boolean }) {
    return (
        <p
            className={`${isApple ? "text-sm font-semibold" : "text-sm font-black"} uppercase tracking-[0.12em] mb-4`}
            style={{ color: palette.textTertiary }}>
            {label}
        </p>
    );
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <span
                ...
                style={{
                    background: status === "active" ? "#30D15820" : status === "wip" ? "#FF9F0A20" : "#8E8E9320",
                    color: status === "active" ? "#30D158" : status === "wip" ? "#FF9F0A" : "#8E8E93"
                }}>
    ...
    return (
        <div>
            <span
                ...
                style={{
                    background: status === "active" ? "#30D15820" : "#FF9F0A20",
                    color: status === "active" ? "#30D158" : "#FF9F0A"
                }}>
