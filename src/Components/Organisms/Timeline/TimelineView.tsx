...
import { School, Work, VerifiedUser, EmojiEvents, LocationOn, OpenInNew, Star } from "@mui/icons-material";
                ...
                <ul className="space-y-1">
                    {edu.Achievements.map((a, i) => (
                        <li
                            ...
                            style={{ color: palette.textSecondary }}>
                            <Star style={{ fontSize: 12, color: "#FF9F0A" }} />
                            {a}
                        </li>
                    ))}
                </ul>
            ...
            <div className="flex flex-col items-center flex-shrink-0 w-10">
                ...
                <div
                    ...
                    style={{
                        ...
                        color: "#fff",
                        boxShadow: `0 0 0 5px ${meta.color}22`
                    }}>
                    {meta.icon}
                </div>
                ...
                <div
                    ...
                    style={{
                        background: `linear-gradient(to bottom, ${meta.color}50, ${isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.06)"})`
                    }}
                />
            </div>
...
export default function TimelineView({ education, experience, certificates, testScores }: Props) {
    ...
    const visible = useMemo(() => (activeKinds.size === 0 ? events : events.filter((e) => activeKinds.has(e.kind))), [events, activeKinds]);
    ...
    return (
        <div className="min-h-screen pt-24 pb-20">
            <div className="max-w-4xl mx-auto px-4 md:px-8">
                ...
                {/* Filters */}
                <motion.div
                    className="flex flex-wrap gap-2 mb-10 p-3"
                    style={cardBg}
