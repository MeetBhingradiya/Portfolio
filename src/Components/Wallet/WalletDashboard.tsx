            ...
            <div className="flex items-center justify-between">
                ...
                {dashboardData.overview && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-slide-up">
                        ...
                        <Card className={`bg-gradient-to-br border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ${
                ...
                {dashboardData.wallets.length === 0 ? (
                    <Card className="text-center py-16 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border-0 shadow-lg animate-fade-in">
                        <CardBody>
                            <div className="space-y-6">
                                <div className="relative">
                                    <BanknotesIcon className="h-24 w-24 mx-auto text-gray-300 dark:text-gray-600" />
                                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full animate-pulse"></div>
                                </div>
                                <div>
                                    <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-300">No Wallets Yet</h3>
                                    <p className="text-gray-500 dark:text-gray-400 mt-2 max-w-md mx-auto">
                                        Start your financial journey by creating your first wallet to track your money
                                    </p>
                                </div>
                                <Button
                                    color="primary"
                        ...
                        {dashboardData.wallets.map((wallet, index) => {
                            ...
                            return (
                                <Card 
                                    ...
                                    className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer"
                                    ...
                                    <CardHeader className="pb-2">
                                        <div className="flex items-center gap-4 w-full">
                                            <Avatar
                                                ...
                                                className={`${
                                                    getTypeColor(wallet.type) === 'primary' ? 'bg-blue-500' : 
