...
interface ITimeline {
    ...
    Start?: `${number}${number}-${number}${number}-${number}${number}${number}${number}` | `${number}${number}-${number}${number}`
    isCurrent?: boolean
    End?: `${number}${number}-${number}${number}-${number}${number}${number}${number}` | `${number}${number}-${number}${number}`
