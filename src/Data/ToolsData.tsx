/**
 *  @FileID          Data/ToolsData.js
 *  @Description     Tool definitions for the Tools navigation
 ...
 *  -----------------------------------------------------------------------------
 *  @created 13/03/25 11:34 AM IST (Kolkata +5:30 UTC)
 *  @modified 13/03/25 11:34 AM IST (Kolkata +5:30 UTC)
 */
