...
const CDNApplicationSchema = new Schema<ICDNApplication>(
    {
        ...
        applicantUserId: { type: String, trim: true, sparse: true, index: true },
...
export const CDNApplication =
    mongoose.models.CDNApplication ||
    mongoose.model<ICDNApplication>("CDNApplication", CDNApplicationSchema);
