...
const RefundRequestSchema = new Schema<IRefundRequest>(
    {
        refundId: { type: String, required: true, unique: true, default: () => require("uuid").v4() },
        ...
        reason: {
            type: String,
            enum: ["not_as_described", "defective", "not_received", "changed_mind",
                "duplicate_purchase", "compatibility_issue", "other"],
            required: true,
        },
