...
const WalletAsset_Schema = new mongoose.Schema(
    {
        ...
        Type: {
            type: String,
            enum: Object.values(WalletAssetType),
            default: WalletAssetType.CASH
        },
...
export const WalletAsset = mongoose.models.WalletAsset || mongoose.model("WalletAsset", WalletAsset_Schema);
