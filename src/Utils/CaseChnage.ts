...
const changeCase: ChangeCaseFunctions = {
    ...
    constant: (input) => input.replace(/[-_\.\s]+/g, "_").toUpperCase(),

    dot: (input) => input.replace(/[-_\s]+/g, ".").toLowerCase(),

    kebab: (input) => input.replace(/[-_\.\s]+/g, "-").toLowerCase(),
    ...
    param: (input) => input.replace(/[-_\.\s]+/g, "-").toLowerCase(),
    ...
    path: (input) => input.replace(/[-_\.\s]+/g, "/").toLowerCase(),
    ...
    snake: (input) => input.replace(/[-_\.\s]+/g, "_").toLowerCase(),
...
export type { CaseTransformer, ChangeCaseFunctions };
