...
function ControllerResponseMapFormData(
    ...
    files: Array<{ buffer: Buffer; filename: string; mimeType: string; metadata?: any }>
): NextResponse {
    ...
    if (missingFields.isMissing) {
        throw new Error("Required Fields are not provided in ControllerResponseMapFormData");
    }
