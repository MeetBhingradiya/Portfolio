/**
 * Checks if the provided date is in the future relative to the current time.
 *
 * @param date - The date to evaluate.
 * @returns True if the provided date is later than the current time; otherwise, false.
 */
