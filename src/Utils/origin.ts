...
export function getTrustedOrigins(): string[] {
    ...
    const defaults = process.env.NODE_ENV === "production" ? DEFAULT_PRODUCTION_ORIGINS : [...DEFAULT_PRODUCTION_ORIGINS, ...DEFAULT_LOCAL_ORIGINS];
