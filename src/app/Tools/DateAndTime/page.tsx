...
const commonTimezones = [
	{ value: "Asia/Calcutta", label: "IST - India" },
	...
	return (
		<div className="Page DateAndTime">
			...
			<p className="description">
				Powerful date and time tools for conversion, calculation, and
				formatting
			</p>
			...
			<div className="clock-container glass">
				...
				<div className="clock-info">
					...
					<div className="info-item">
						...
						<div className="info-value">
							{dayjs(currentDate).utc().format("HH:mm:ss")}
						</div>
					</div>
					<div className="info-item">
						<div className="info-label">Day of Year</div>
						<div className="info-value">
							{dayjs(currentDate).dayOfYear()}
						</div>
					</div>
				</div>
			</div>
			...
			<div className="utilities-container">
				...
				<div className="utility-box glass">
					...
					<div className="utility-content">
						...
						<button
							...
							onClick={() =>
								calculateAge(birthDate, birthTime, setAgeResult)
							}
						>
							Calculate Age
						</button>
							...
							<div className="result-container">
								...
								<div className="result-grid">
									<div className="result-item">
										...
										<div className="result-value">
											{dayjs(timestampResult).format("YYYY-MM-DD")}
										</div>
									</div>
									<div className="result-item">
										<div className="result-label">Time</div>
										<div className="result-value">
											{dayjs(timestampResult).format("HH:mm:ss")}
										</div>
									</div>
									<div className="result-item">
										<div className="result-label">Day</div>
										<div className="result-value">
											{dayjs(timestampResult).format("dddd")}
										</div>
									</div>
									<div className="result-item">
										<div className="result-label">UTC</div>
										<div className="result-value">
											{dayjs(timestampResult).utc().format("YYYY-MM-DD HH:mm:ss")}
										</div>
									</div>
								</div>
								...
								<div className="format-examples">
									...
									<div className="format-item">
										...
										<div className="format-result">
											{timestampResult.toLocaleString()}
										</div>
										<div
											className="copy-btn"
											onClick={() =>
							...
							<div className="result-container">
								...
								<div className="result-grid">
									...
									<div className="result-item">
										...
										<div className="result-value">
											{Math.floor(dateStringResult.getTime() / 1000)}
										</div>
									</div>
									<div className="result-item">
										<div className="result-label">
										...
										<div className="result-value">
											{
												dateStringResult.toISOString().split("T")[0]
											}
										</div>
									</div>
									<div className="result-item">
										...
										<div className="result-value">
											{dayjs(dateStringResult).utc().format("HH:mm:ss")}
										</div>
									</div>
								</div>
								...
								<div className="format-examples">
									...
									<div className="format-item">
										...
										<div className="format-result">
											{dateStringResult.toLocaleString()}
										</div>
										<div
											className="copy-btn"
											onClick={() =>
									...
									<div className="format-item">
										...
										<div className="format-result">
											{dayjs(dateStringResult).fromNow()}
										</div>
										<div
											className="copy-btn"
											onClick={() =>
							...
							<div className="result-container">
								...
								<div className="relative-time-section">
									<div className="result-text">
										Human-readable:{" "}
										<span>
											{relativeTimeResult.humanReadable}
										</span>
									</div>
									<div className="result-text">
										{relativeTimeResult.startDate.toLocaleDateString()}{" "}
										is{" "}
										<span>
											{relativeTimeResult.fromNow}
										</span>
									</div>
								</div>
							</div>
					...
					<div className="utility-content">
						<div className="format-examples">
							...
							<div className="format-item">
								...
								<div className="format-result">
									{dayjs(currentDate).format("DD/MM/YYYY HH:mm:ss")}
								</div>
								<div
									className="copy-btn"
									onClick={() => copyToClipboard(dayjs(currentDate).format("DD/MM/YYYY HH:mm:ss"))}
								>
									<ContentCopy fontSize="small" />
								</div>
							</div>
				...
				<div className="utility-box glass world-clock-container">
					<div className="utility-header">
						<h2>World Clock</h2>
						<Public />
					</div>
						...
						<div className="world-clock-grid">
							<div className="world-clock-item">
								...
								<div className="city-time">
									{dayjs(currentDate).tz("America/New_York").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">EST/EDT</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">London</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Europe/London").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">GMT/BST</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Tokyo</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Asia/Tokyo").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">JST</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Sydney</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Australia/Sydney").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">AEST/AEDT</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Mumbai</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Asia/Kolkata").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">IST</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Dubai</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Asia/Dubai").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">GST</div>
							</div>
							<div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Paris</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Europe/Paris").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">CET/CEST</div>
							</div>
							{/* <div className="world-clock-item">
								<div className="time-indicator"></div>
								<div className="city-name">Shanghai</div>
								<div className="city-time">
									{dayjs(currentDate).tz("Asia/Shanghai").format("HH:mm:ss")}
								</div>
								<div className="city-timezone">CST</div>
							</div> */}
						</div>
					</div>
				</div>
