...
export default function EncryptAndDecrypt() {
    ...
    return (
        <div className="Page EncryptAndDecrypt">
            ...
            <p className="description">Encrypt and decrypt text using various cryptographic algorithms</p>
            ...
            <div className="crypto-container">
                ...
                <div className="controls-section glass">
                    <div className="mode-toggle">
                        <button 
                            ...
                            onClick={() => setState({ ...state, mode: 'encrypt' })}
                        >
                            <Lock />
                            Encrypt
                        </button>
                        <button 
                            ...
                            onClick={() => setState({ ...state, mode: 'decrypt' })}
                        >
                            <LockOpen />
                            Decrypt
                        </button>
                    ...
                    <div className="algorithm-selector">
                        ...
                        <select 
                            ...
                            onChange={(e) => setState({ ...state, algorithm: e.target.value as Algorithm })}
                        >
                            {algorithms.map(algo => (
                ...
                <div className="input-section glass">
                    <div className="section-header">
                        <h2>{state.mode === 'encrypt' ? 'Plain Text' : 'Encrypted Text'}</h2>
                    </div>
                    <textarea
                        value={state.text}
                ...
                <div className="key-section glass">
                    <div className="section-header">
                        ...
                        <div className="key-actions">
                            ...
                            <Button
                                onPress={() => setState({ ...state, showKey: !state.showKey })}
                                title={state.showKey ? "Hide key" : "Show key"}
                                variant="ghost"
                                isIconOnly
                                size="sm"
                            >
                                {state.showKey ? <VisibilityOff /> : <Visibility />}
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="key-info">
                        <p>Recommended key length: {state.algorithm === 'AES' ? '32' : '16'} characters</p>
                ...
                <div className="action-buttons">
                    <Button
                        ...
                        color="primary"
                        size="lg"
                        startContent={state.mode === 'encrypt' ? <Lock /> : <LockOpen />}
                    >
                ...
                {state.result && (
                    <div className="result-section glass">
                        <div className="section-header">
                            <h2>{state.mode === 'encrypt' ? 'Encrypted Text' : 'Decrypted Text'}</h2>
                            <Button
                        ...
                        <div className="result-info">
                            ...
                            <p>Output length: {state.result.length} characters</p>
                        </div>
                    </div>
                )}
                    ...
                    <div className="algorithm-info">
                        {state.algorithm === 'AES' && (
                            <div>
                                ...
                                <p>AES is a symmetric encryption algorithm widely used and trusted by security professionals. It&apos;s considered highly secure and is used by governments and organizations worldwide.</p>
                                <ul>
                                    <li>Key size: Supports 128, 192, and 256-bit keys</li>
                                    <li>Security: Very high - recommended for sensitive data</li>
                        ...
                        {state.algorithm === 'DES' && (
                            <div>
                                ...
                                <p>DES is an older encryption standard that is now considered weak due to its small key size. Not recommended for securing sensitive data.</p>
                                <ul>
                                    <li>Key size: 56-bit effective key size</li>
                                    <li>Security: Low - deprecated and easily broken</li>
                        ...
                        {state.algorithm === 'TripleDES' && (
                            <div>
                                ...
                                <p>TripleDES applies DES encryption three times to increase security. While more secure than DES, it&apos;s slower than modern alternatives.</p>
                                <ul>
                                    <li>Key size: 112 or 168-bit effective key size</li>
                        ...
                        {state.algorithm === 'Rabbit' && (
                            <div>
                                ...
                                <p>Rabbit is a high-speed stream cipher designed for software implementations. It&apos;s fast and secure for real-time applications.</p>
                                <ul>
                                    <li>Key size: 128-bit</li>
                                    <li>Security: High - no known practical attacks</li>
                        ...
                        {state.algorithm === 'RC4' && (
                            <div>
                                ...
                                <p>RC4 is a stream cipher that was widely used but has known vulnerabilities. Not recommended for new applications.</p>
                                <ul>
                                    <li>Key size: Variable (40-2048 bits)</li>
                                    <li>Security: Low - has known vulnerabilities</li>
                                    <li>Usage: Legacy systems only</li>
                                </ul>
                            </div>
                        )}
