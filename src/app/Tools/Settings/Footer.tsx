...
function Footer({ ModalState, SetModalState, State, SetState }: FooterProps) {
    ...
    return (
        <ModalFooter
            ...
            style={{
                position: "absolute",
                display: LongSidebarsOn.includes(ModalState.type)
                    ? "none"
                    : undefined,
                bottom: 0,
                left: 0,
                    ...
                    <Button
                        ...
                        onPress={() => {
                            ...
                            const index = State.Bookmarks.findIndex(
                                (b) =>
                                    b.BookmarkID ===
                                    ModalState.bookmark.BookmarkID
                            );
                            if (index === -1) {
                                return;
                            }
                            ...
                            if (
                                ...
                                toast.info(
                                    "Bookmark changes will be synced with cloud on next sync"
                                );
                            }
                    ...
                    <Button
                        ...
                        onPress={() => {
                            ...
                            if (
                                ...
                                toast.info(
                                    "New bookmark will be synced to cloud on next sync"
                                );
                            }
