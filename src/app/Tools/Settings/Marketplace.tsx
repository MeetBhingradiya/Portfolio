...
function Marketplace({
    ...
    const handleSearchChange = async (
        ...
        const filteredBookmarks = ModalState.RemoteBookmarks.filter(
            (bookmark) => {
                return (
        ...
        try {
            ...
            const existingIds = State.Bookmarks.map(
            ...
            const requestBody = {
                ...
                adminSignature: ModalState.isAdmin
            ...
            if (response.data.Status === 1) {
                ...
                const newBookmarks = data.Bookmarks.filter(
                    (bookmark: any) =>
                        !ModalState.RemoteBookmarks.some(
    ...
    const addSelectedBookmarks = () => {
        ...
        if (bookmarksToAdd.length > 0) {
            ...
            setRemoteBookmarks(
                ModalState.RemoteBookmarks.filter(
                    (b) =>
                        !bookmarksToAdd.some(
                            (added) => added.BookmarkID === b.BookmarkID
                        )
        ...
        <div className="flex flex-col gap-3 w-full">
            <div className="flex flex-col gap-2 justify-center items-center">
                ...
                <Typography
                    ...
                    Discover and add new bookmarks to your collection from our
                    curated marketplace.
                </Typography>
            </div>
            ...
            <div
                ...
                <div className="flex justify-between items-end mb-2">
                    ...
                    <Button
                        color="secondary"
                        variant={
                            selectedBookmarks.size === 0 ? "light" : "shadow"
                        }
                ...
                <div className="flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <Typography
                        ...
                        {ModalState.MarketPlaceQuery
                            ...
                            : "Check back later or Type to Search"}
                    </Typography>
                    {/* {!ModalState.MarketPlaceQuery && (
                            <Button
                                variant="light"
