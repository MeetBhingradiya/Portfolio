    ...
    const PlateformPriorityOptions = [
        {
            value: "web",
            label: "Web",
            icon: <Language className={`w-8 h-8 ${State.Preferences.PlateformPriority === "web"
                ? "text-primary"
                : "text-gray-400"
                }`} />,
        ...
        },
        {
            value: "mobile",
            label: "Mobile",
            icon: <Android className={`w-8 h-8 ${State.Preferences.PlateformPriority === "mobile"
                ? "text-primary"
                : "text-gray-400"
                }`} />,
        ...
        },
        {
            value: "desktop",
            label: "Desktop",
            icon: <Window className={`w-8 h-8 ${State.Preferences.PlateformPriority === "desktop"
                ? "text-primary"
                : "text-gray-400"
                }`} />,
        ...
        <div className="flex flex-col gap-6 w-full mx-auto">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-4">
                        {searchEngineOptions.map((engine) => (
                            <div
                                key={engine.value}
                                className={`flex items-center justify-center gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.SearchEngine === engine.value
                                    ? "border-primary bg-primary-50 dark:bg-primary-900/10"
                                    : "border-gray-200 dark:border-gray-700"
                                    }`}
                                onClick={() => handlePreferenceChange("SearchEngine", engine.value)}
                            >
                                {engine.icon}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs text-gray-500 mb-2">When enabled, suggestions will be generated locally from your bookmarks</p>
                    <Select
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        {linkOpenOptions.map((option) => (
                            <div
                                key={option.value}
                                className={`flex items-center justify-center gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.OpenMethod === option.value
                                    ? "border-primary bg-primary-50 dark:bg-primary-900/10"
                                    : "border-gray-200 dark:border-gray-700"
                                    }`}
                                onClick={() => handlePreferenceChange("OpenMethod", option.value)}
                            >
                                {option.icon}
                ...
                <div className="flex flex-col gap-2 mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        {PlateformPriorityOptions.map((option) => (
                            <div
                                key={option.value}
                                className={`flex flex-col gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.PlateformPriority === option.value
                                    ? "border-primary bg-primary-50 dark:bg-primary-900/10"
                                    : "border-gray-200 dark:border-gray-700"
                                    }`}
                                onClick={() => handlePreferenceChange("PlateformPriority", option.value)}
                            >
                                <div className="flex items-center justify-center">
                                    {option.icon}
                                </div>
                                <div className="text-center">
                                    <p className={`font-medium ${State.Preferences.PlateformPriority === option.value
                                        ? "text-primary"
                                        : ""
                                        }`}>{option.label}</p>
                    ...
                    <p className="text-xs text-gray-400 mb-2">
                        <span className="text-yellow-500 font-semibold">Note:</span> Changing this option will change the default behavior of the bookmark system. You can still open links in a different platform by using the context menu or the right-click menu.
                    </p>  
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Context menu options for Android (Mobile) and Windows (Desktop) apps</p>
                ...
                <p className="text-xs text-gray-400 mb-2">
                        <span className="text-red-500 font-semibold">Note:</span> Mac & IOS are never be supported even if you requested to us. Linux is not supported yet. We are working on it.
                    </p> 
            </div>
                ...
                <FormControlLabel
                    ...
                    label={
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-gray-500">
                                Sync bookmarks across the cloud updates automatically
                            </span>
                        </div>
                    }
                />
                ...
                <FormControlLabel
                    ...
                    label={
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-gray-500">
                                Display labels on bookmarks for easier identification of Webapp or Site
                            </span>
                        </div>
                    }
                />
