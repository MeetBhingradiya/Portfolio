                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2 mt-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                                <div
                                    className={`flex flex-col gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.PlateformPriority === "web"
                                ...
                                >
                                    <div className="flex items-center justify-center">
                                        <Language className={`w-8 h-8 ${State.Preferences.PlateformPriority === "web"
                                            ? "text-primary"
                                            : "text-gray-400"
                                            }`} />
                                    </div>
                                    <div className="text-center">
                                        <p className={`font-medium ${State.Preferences.PlateformPriority === "web"
                                            ? "text-primary"
                                            : ""
                                            }`}>Web</p>
                                ...
                                <div
                                    className={`flex flex-col gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.PlateformPriority === "mobile"
                                        ? "border-primary bg-primary-50 dark:bg-primary-900/10"
                                        : "border-gray-200 dark:border-gray-700"
                                        }`}
                                ...
                                >
                                    <div className="flex items-center justify-center">
                                        <Android className={`w-8 h-8 ${State.Preferences.PlateformPriority === "mobile"
                                            ? "text-primary"
                                            : "text-gray-400"
                                            }`} />
                                    </div>
                                    <div className="text-center">
                                        <p className={`font-medium ${State.Preferences.PlateformPriority === "mobile"
                                            ? "text-primary"
                                            : ""
                                            }`}>Mobile</p>
                                ...
                                <div
                                    className={`flex flex-col gap-2 p-3 rounded-lg border-2 cursor-pointer transition-all ${State.Preferences.PlateformPriority === "desktop"
                                        ? "border-primary bg-primary-50 dark:bg-primary-900/10"
                                        : "border-gray-200 dark:border-gray-700"
                                        }`}
                                ...
                                >
                                    <div className="flex items-center justify-center">
                                        <Window className={`w-8 h-8 ${State.Preferences.PlateformPriority === "desktop"
                                            ? "text-primary"
                                            : "text-gray-400"
                                            }`} />
                                    </div>
                                    <div className="text-center">
                                        <p className={`font-medium ${State.Preferences.PlateformPriority === "desktop"
                                            ? "text-primary"
                                            : ""
                                            }`}>Desktop</p>
