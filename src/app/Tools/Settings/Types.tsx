...
export const DefualtBookmarks: Array<IBookmark> = [
    {
        BookmarkID: v4(),
        Name: "QR Code",
        WebLink: "/Tools/QR",
        Keywords: ["qr", "code", "generator", "scanner", "tools"],
        Icon: <QrCode2 sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "UUID Generator",
        WebLink: "/Tools/UUID",
        Keywords: ["uuid", "generator", "tools"],
        Icon: <Fingerprint sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "JSON ⇄ Object",
        WebLink: "/Tools/JSONObject",
        Keywords: ["json", "object", "converter", "tools"],
        Icon: <DataObject sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "CRX Downloader",
        WebLink: "/Tools/CRX",
        Keywords: ["crx", "downloader", "chrome", "extension", "tools"],
        Icon: <Extension sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        ...
        WebLink: "/Tools/URL",
        Keywords: ["url", "encode", "decode", "tools"],
        Icon: <LinkOutlined sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Date & Time Utils",
        WebLink: "/Tools/DateAndTime",
        Keywords: ["date", "time", "utils", "tools"],
        Icon: <CalendarMonth sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Colour Picker",
        WebLink: "/Tools/ColourPicker",
        Keywords: ["colour", "picker", "tools"],
        Icon: <Colorize sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Markdown",
        WebLink: "/Tools/Markdown",
        Keywords: ["markdown", "preview", "tools"],
        Icon: <DescriptionOutlined sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "JWT Decoder",
        WebLink: "/Tools/JWT",
        Keywords: ["jwt", "decoder", "tools"],
        Icon: <Security sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "RegExp Builder",
        WebLink: "/Tools/RegExp",
        Keywords: ["regexp", "tester", "builder", "tools"],
        Icon: <Code sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Password Generation",
        WebLink: "/Tools/Password",
        Keywords: ["password", "generator", "tools"],
        Icon: <Password sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Encrypt & Decrypt",
        WebLink: "/Tools/EncryptAndDecrypt",
        Keywords: ["encrypt", "decrypt", "tools"],
        Icon: <Key sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Image Compress",
        WebLink: "/Tools/ImageCompress",
        Keywords: ["image", "compress", "tools"],
        Icon: <Compress sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Image > PDF",
        WebLink: "/Tools/ImageToPDF",
        Keywords: ["image", "pdf", "tools"],
        Icon: <PictureAsPdf sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    },
    {
        BookmarkID: v4(),
        Name: "Hashing",
        WebLink: "/Tools/Hash",
        Keywords: ["hash", "generator", "tools"],
        Icon: <Tag sx={{ width: 64, height: 64 }} />,
        ...CommanSettings
    }
];
...
export { ILocale, ISearchEngines, ILinkOpenTypes, IToolsSettingsTabs };
