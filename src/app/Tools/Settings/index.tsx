...
import type { IBookmark, IToolsState, IToolsModalData } from "./Types";
...
function ModelsBody({ ModalState, SetModalState, State, Dispatch }: BodyProps) {
    ...
    return (
        <ModalBody
            ...
            <div
                className={
                    "flex flex-col gap-4 px-2 pt-16 pb-16 z-0 HideScrollbars"
                }
                style={{
                    width: "100%",
                    overflow: "auto",
                ...
                {ModalState.type === IToolsSettingsTabs.BeAdmin && (
                    <BeAdmin SetModalState={SetModalState} />
                )}
