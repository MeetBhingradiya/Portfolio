...
const mockProjects: Project[] = [
    {
        ...
        description:
            "Modern full-stack e-commerce solution with Next.js and Stripe",
        fullDescription:
            "A complete e-commerce platform built with Next.js, TypeScript, and Tailwind CSS. Features include user authentication, product catalog, shopping cart, payment processing with Stripe, order management, and admin dashboard.",
    ...
    },
    {
        ...
        fullDescription:
            "A collaborative task management application with real-time synchronization, team collaboration features, project organization, and advanced filtering options.",
    ...
    },
    {
        ...
        fullDescription:
            "A cross-platform mobile weather application built with React Native, featuring beautiful weather animations, location-based forecasts, and offline data caching.",
    ...
    },
    {
        ...
        fullDescription:
            "An AI-powered content generation platform that helps marketers create blog posts, social media content, and marketing copy using advanced language models.",
    ...
    const ProjectForm = () => (
        <div className="space-y-4">
            <Input
                ...
                onValueChange={(value) =>
                    setEditingProject((prev) => ({ ...prev, title: value }))
                }
                isRequired
            />
            <Textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Select
                    label="Category"
                    selectedKeys={
                        editingProject.category ? [editingProject.category] : []
                    }
                ...
                <Select
                    label="Status"
                    selectedKeys={
                        editingProject.status ? [editingProject.status] : []
                    }
                    onSelectionChange={(keys) =>
                        setEditingProject((prev) => ({
                            ...prev,
                            status: Array.from(keys)[0] as Project["status"]
                        }))
                    }>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-default-500">
                                Manage your projects and portfolio showcase
                            </p>
                        </div>
                        <Button
                            color="primary"
