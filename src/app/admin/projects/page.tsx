...
const fields: FieldDef[] = [
    ...
    },
    {
        ...
        label: "Type",
        type: "select",
        options: ["website", "webapp", "chrome_extension", "npm_package", "playstore_app", "github_repo", "other"],
        required: true
    },
    {
        key: "Status",
    ...
    {
        key: "Icon",
        label: "Icon (128×128 square, e.g. Chrome extension)",
        type: "cdn-image",
        cdnType: "icon",
        cdnContext: "project",
        tableVisible: false
