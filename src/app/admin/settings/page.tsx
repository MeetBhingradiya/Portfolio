				...
				<div className="flex flex-col gap-4">
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="text-default-500">Configure your site settings and preferences</p>
						</div>
						<div className="flex items-center gap-2">
							...
							<Button
								...
								startContent={saveStatus === "saved" ? <CheckCircle /> : <Save />}
						...
						>
							...
							>
								<div className="p-6 space-y-6">
									...
									<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
										...
										<Select
											label="Timezone"
											selectedKeys={[siteSettings.timezone]}
											onSelectionChange={(keys) => setSiteSettings({
												...siteSettings,
												timezone: Array.from(keys)[0] as string
											})}
										>
											<SelectItem key="UTC">UTC</SelectItem>
											<SelectItem key="EST">Eastern Time</SelectItem>
											<SelectItem key="PST">Pacific Time</SelectItem>
											<SelectItem key="GMT">Greenwich Mean Time</SelectItem>
										</Select>
										<Select
											label="Language"
											selectedKeys={[siteSettings.language]}
											onSelectionChange={(keys) => setSiteSettings({
												...siteSettings,
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Allow new users to register</div>
												</div>
												<Switch
													isSelected={siteSettings.allowRegistration}
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Require email verification for new users</div>
												</div>
												<Switch
													isSelected={siteSettings.requireEmailVerification}
													onValueChange={(value) => setSiteSettings({
														...siteSettings,
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Enable commenting system</div>
												</div>
												<Switch
													isSelected={siteSettings.enableComments}
													onValueChange={(value) => setSiteSettings({
														...siteSettings,
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Enable site analytics tracking</div>
												</div>
												<Switch
													isSelected={siteSettings.enableAnalytics}
													onValueChange={(value) => setSiteSettings({
														...siteSettings,
											...
											<div className="flex items-center justify-between p-4 border border-warning-200 rounded-lg bg-warning-50">
												<div className="flex items-center gap-3">
													...
													<div>
														...
														<div className="text-sm text-default-500">Put the site in maintenance mode</div>
													</div>
												</div>
												<Switch
													isSelected={siteSettings.enableMaintenance}
													onValueChange={(value) => setSiteSettings({
														...siteSettings,
							...
							>
								<div className="p-6 space-y-6">
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Require 2FA for admin accounts</div>
												</div>
												<Switch
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Enable CAPTCHA for forms</div>
												</div>
												<Switch
													isSelected={securitySettings.enableCaptcha}
													onValueChange={(value) => setSecuritySettings({
														...securitySettings,
														enableCaptcha: value
													})}
									...
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
										...
										<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
											<div>
												...
												<div className="text-xs text-default-500">Require complex passwords</div>
											</div>
											<Switch
									...
									<div className="space-y-4">
										<h3 className="text-lg font-semibold">Trusted Domains</h3>
										<div className="space-y-2">
											{securitySettings.trustedDomains.map((domain, index) => (
												<div key={index} className="flex items-center gap-2">
													<Input
														value={domain}
														onChange={(e) => {
															const newDomains = [...securitySettings.trustedDomains];
													...
													<Button
														...
														variant="light"
														onPress={() => {
															const newDomains = securitySettings.trustedDomains.filter((_, i) => i !== index);
															setSecuritySettings({
																...securitySettings,
																trustedDomains: newDomains
															});
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div className="flex items-center gap-3">
													...
													<div>
														...
														<div className="text-sm text-default-500">Receive browser push notifications</div>
													</div>
												</div>
												<Switch
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Get notified when users register</div>
												</div>
												<Switch
													isSelected={notificationSettings.newUserNotifications}
													onValueChange={(value) => setNotificationSettings({
														...notificationSettings,
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Get notified about new comments</div>
												</div>
												<Switch
													isSelected={notificationSettings.commentNotifications}
													onValueChange={(value) => setNotificationSettings({
														...notificationSettings,
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Get notified about system issues</div>
												</div>
												<Switch
											...
											<div className="flex items-center justify-between p-4 border border-default-200 rounded-lg">
												<div>
													...
													<div className="text-sm text-default-500">Receive marketing and promotional emails</div>
												</div>
												<Switch
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
										...
										<Card>
											...
											<CardBody className="space-y-3">
												...
												<div className="flex justify-between">
													<span className="text-default-500">Database Size:</span>
									...
									<Card>
										...
										<CardBody>
											<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
												<Button color="primary" variant="flat">Clear Page Cache</Button>
												<Button color="primary" variant="flat">Clear Database Cache</Button>
												<Button color="primary" variant="flat">Clear All Caches</Button>
											</div>
										</CardBody>
									</Card>
									...
									<Card>
										...
										<CardBody>
											<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
												<Button variant="flat">Error Logs</Button>
												<Button variant="flat">Access Logs</Button>
												<Button variant="flat">Security Logs</Button>
												<Button variant="flat">Download All</Button>
											</div>
										</CardBody>
									</Card>
								</div>
						...
						{(onClose) => (
							<>
								<ModalHeader className="flex flex-col gap-1">
									<h3 className="text-lg font-semibold">Create System Backup</h3>
									<p className="text-sm text-default-500">
										This will create a complete backup of your site data and settings.
									</p>
								</ModalHeader>
								<ModalBody>
									<div className="space-y-4">
										...
										<div className="space-y-2">
											...
											<div className="flex items-center gap-2">
												<input type="checkbox" defaultChecked className="rounded" />
												<span className="text-sm">Include uploaded files</span>
											</div>
											<div className="flex items-center gap-2">
												<input type="checkbox" defaultChecked className="rounded" />
												<span className="text-sm">Include configuration</span>
											</div>
										</div>
									</div>
								</ModalBody>
