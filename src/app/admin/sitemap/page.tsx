...
const fields: FieldDef[] = [
    ...
    { key: "Group", label: "Group", type: "text", placeholder: "main / tools / legal / blogs / projects" },
...
function SeedBanner() {
    ...
    return (
        ...
        >
            <div>
                <p className="text-sm font-bold" style={{ color: palette.textPrimary }}>Seed Static Pages</p>
