                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span
                                            ...
                                            style={{
                                                background: `${STATUS_COLORS[t.status] ?? "#8E8E93"}18`,
                                                color: STATUS_COLORS[t.status] ?? "#8E8E93"
                                            }}>
                                            {t.status.replace("_", " ")}
                                        </span>
                                        <span
                                            className="text-xs px-2 py-0.5 rounded-full font-bold capitalize"
                                            style={{
                                                background: `${PRIORITY_COLORS[t.priority] ?? palette.accent}18`,
                                                color: PRIORITY_COLORS[t.priority] ?? palette.accent
                                            }}>
                                            {t.priority}
                                        </span>
                                    </div>
