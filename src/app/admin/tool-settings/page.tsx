...
const INITIAL_DEFAULTS: ToolDefaults = {
    ...
    instagram: {
        defaultTab: "not-following-back",
        showDates: true,
        useRegExpByDefault: false,
        maxListHeight: "normal"
    },
    visibility: []
};
...
const TOOL_VISIBILITY_SECTIONS = [
    ...
    {
        id: "paperknife-merge",
        name: "PaperKnife: Merge PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-split",
        name: "PaperKnife: Split PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-compress",
        name: "PaperKnife: Compress PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-protect",
        name: "PaperKnife: Protect PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-unlock",
        name: "PaperKnife: Unlock PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-rotate-pdf",
        name: "PaperKnife: Rotate PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-rearrange-pdf",
        name: "PaperKnife: Rearrange PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-page-numbers",
        name: "PaperKnife: Page Numbers",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-watermark",
        name: "PaperKnife: Watermark",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-metadata",
        name: "PaperKnife: Metadata",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-signature",
        name: "PaperKnife: Signature",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-grayscale",
        name: "PaperKnife: Grayscale",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-pdf-to-image",
        name: "PaperKnife: PDF to Image",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-image-to-pdf",
        name: "PaperKnife: Image to PDF",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-extract-images",
        name: "PaperKnife: Extract Images",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-pdf-to-text",
        name: "PaperKnife: PDF to Text",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    },
    {
        id: "paperknife-repair",
        name: "PaperKnife: Repair",
        icon: <PictureAsPdf fontSize="small" />,
        color: "#F43F5E"
    }
];
...
export default function ToolSettingsPage() {
    ...
    const updateVisibility = (
        ...
        setDefaults((prev) => {
            ...
            const next = idx >= 0 ? existing.map((v, i) => (i === idx ? updated : v)) : [...existing, updated];
    ...
    const fetchSettings = useCallback(async () => {
        ...
        try {
            ...
            patchUi({ error: "Failed to load settings" });
        }
    ...
    const toggleAccordion = (id: string) =>
        setUi((s) => ({
            ...s,
            expandedTool: s.expandedTool === id ? null : id
        }));
                        ...
                        <div
                            ...
                            <button
                                onClick={() =>
                                    setUi((s) => ({
                                        ...s,
                                        visibilityOpen: !s.visibilityOpen
                                    }))
                                }
                                ...
                                <motion.div
                                    animate={{
                                        rotate: ui.visibilityOpen ? 180 : 0
                                    }}
                ...
                <div className={grid}>
                    ...
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["rounded", "dots", "classy", "classy-rounded", "square", "extra-rounded"].map((v) => ({
                                value: v,
                                label: v
                            }))}
                        />
                ...
                <div className={grid}>
                    ...
                    <Field
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                updateTool("uuid", {
                                    bulkCount: Number(e.target.value)
                                })
                            }
                            style={inputStyle}
                        />
                    ...
                    <Field
                        ...
                        <div className="flex flex-wrap gap-3">
                            <CheckToggle
                                label="Uppercase"
                                checked={d.uppercase}
                                onChange={(v) => updateTool("uuid", { uppercase: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="No dashes"
                                checked={d.noDashes}
                                onChange={(v) => updateTool("uuid", { noDashes: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Braces {}"
                                checked={d.braces}
                                onChange={(v) => updateTool("uuid", { braces: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                        </div>
                    ...
                    <Field
                        ...
                        <div className="flex flex-wrap gap-3">
                            <CheckToggle
                                label="Uppercase A-Z"
                                checked={d.uppercase}
                                onChange={(v) => updateTool("password", { uppercase: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Lowercase a-z"
                                checked={d.lowercase}
                                onChange={(v) => updateTool("password", { lowercase: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Digits 0-9"
                                checked={d.digits}
                                onChange={(v) => updateTool("password", { digits: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Symbols !@#$"
                                checked={d.symbols}
                                onChange={(v) => updateTool("password", { symbols: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Exclude ambiguous"
                                checked={d.excludeAmbiguous}
                                onChange={(v) =>
                                    updateTool("password", {
                                        excludeAmbiguous: v
                                    })
                ...
                <div className={grid}>
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["all", "active", "completed"].map((v) => ({
                                value: v,
            ...
            return (
                <div className={grid}>
                    <Field
                        ...
                        <input
                            type="text"
                            value={d.defaultFlags}
                            onChange={(e) =>
                                updateTool("regexp", {
                                    defaultFlags: e.target.value
                                })
                            }
                            placeholder="g, gi, gm…"
                    ...
                    <Field
                        ...
                        colSpan>
                        <CheckToggle
                            label="Show presets by default"
                            checked={d.showPresets}
                            onChange={(v) => updateTool("regexp", { showPresets: v })}
                            palette={palette}
                            isDark={isDark}
                        />
                    </Field>
                ...
                <div className={grid}>
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["decode", "build", "reference"].map((v) => ({
                                value: v,
                                label: v[0].toUpperCase() + v.slice(1)
                            }))}
                        />
            ...
            return (
                <div className={grid}>
                    ...
                    <Field
                        ...
                        palette={palette}>
                        <CheckToggle
                            label="Auto-format on load"
                            checked={d.autoFormat}
                            onChange={(v) => updateTool("json", { autoFormat: v })}
                            palette={palette}
                            isDark={isDark}
                        />
                    </Field>
        ...
        case "image": {
            ...
            return (
                <div className={grid}>
                    ...
                    <Field
                        label={`Compression Quality — ${Math.round(d.quality * 100)}%`}
                        palette={palette}
                        colSpan>
                        <input
                            type="range"
                ...
                <div className={grid}>
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["split", "editor", "preview"].map((v) => ({
                                value: v,
                                label: v[0].toUpperCase() + v.slice(1)
                            }))}
                        />
                ...
                <div className={grid}>
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["picker", "palette", "contrast"].map((v) => ({
                                value: v,
                                label: v[0].toUpperCase() + v.slice(1)
                            }))}
                        />
                    ...
                    <Field
                        ...
                        <SimpleSelect
                            ...
                            palette={palette}
                            isDark={isDark}
                            options={["complementary", "analogous", "triadic", "split-comp", "tetradic"].map((v) => ({
                                value: v,
                                label: v
                            }))}
                        />
                    ...
                    <Field
                        label={`Default Hue — ${d.defaultHue}°`}
                        palette={palette}
                        colSpan>
                        <input
                            type="range"
                            ...
                            onChange={(e) =>
                                updateTool("colour", {
                                    defaultHue: Number(e.target.value)
                                })
                            }
                            className="w-full"
                            style={{
                                accentColor: `hsl(${d.defaultHue}, 80%, 55%)`
                            }}
                        />
                    </Field>
                    <Field
                        label={`Saturation — ${d.defaultSaturation}%`}
                        palette={palette}>
                        <input
                            type="range"
                            min={0}
                            max={100}
                            value={d.defaultSaturation}
                            onChange={(e) =>
                                updateTool("colour", {
                                    defaultSaturation: Number(e.target.value)
                                })
                            }
                            className="w-full"
                            style={{ accentColor: palette.accent }}
                    ...
                    <Field
                        label={`Lightness — ${d.defaultLightness}%`}
                        palette={palette}>
                        <input
                            type="range"
                            min={0}
                            max={100}
                            value={d.defaultLightness}
                            onChange={(e) =>
                                updateTool("colour", {
                                    defaultLightness: Number(e.target.value)
                                })
                            }
                            className="w-full"
                            style={{ accentColor: palette.accent }}
            ...
            return (
                <div className={grid}>
                    <Field
                        ...
                        <SimpleSelect
                            value={d.defaultTab}
                            onChange={(v) => updateTool("instagram", { defaultTab: v })}
                            inputStyle={inputStyle}
                            palette={palette}
                            isDark={isDark}
                            options={[
                    ...
                    <Field
                        ...
                        palette={palette}>
                        <SimpleSelect
                            value={d.maxListHeight}
                            onChange={(v) => updateTool("instagram", { maxListHeight: v })}
                            inputStyle={inputStyle}
                            palette={palette}
                            isDark={isDark}
                            options={[
                    ...
                    <Field
                        ...
                        <div className="flex flex-wrap gap-3">
                            <CheckToggle
                                label="Show follow dates"
                                checked={d.showDates}
                                onChange={(v) => updateTool("instagram", { showDates: v })}
                                palette={palette}
                                isDark={isDark}
                            />
                            <CheckToggle
                                label="Enable RegExp by default"
                                checked={d.useRegExpByDefault}
                                onChange={(v) =>
                                    updateTool("instagram", {
                                        useRegExpByDefault: v
                                    })
                                }
                                palette={palette}
                                isDark={isDark}
...
function Field({
    ...
    return (
        <div className={colSpan ? "col-span-full" : ""}>
            <label
                className="text-xs font-bold mb-1.5 block uppercase tracking-wider"
                style={{ color: palette.textTertiary }}>
                {label}
            </label>
            {children}
