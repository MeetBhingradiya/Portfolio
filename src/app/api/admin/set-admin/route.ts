...
export async function PUT(request: NextRequest) {
    try {
        ...
        log(`Admin status ${makeAdmin ? 'granted to' : 'revoked from'} user ${updatedUser.Username} (${userID}) by ${currentUser.Username}`);
...
export async function GET(request: NextRequest) {
    try {
        ...
        const isAdminUser = currentUser.isAdmin || currentUser.Username === "MeetBhingradiya";
        ...
        return NextResponse.json(
            {
                ...
                Data: {
                    ...
                    hasSpecialUsername: currentUser.Username === "MeetBhingradiya"
                }
            },
            { status: 200 }
        );
