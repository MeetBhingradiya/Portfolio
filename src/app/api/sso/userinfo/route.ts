 ...
 *
 * Applications call this with the access_token to get the user's profile.
 * Returns: sub, email, name, email_verified, preferred_username
 */
...
async function handleUserInfo(req: NextRequest): Promise<NextResponse> {
    ...
    const { publicKey } = await getOIDCKeys();
