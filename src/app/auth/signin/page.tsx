                ...
                try {
                    ...
                    if (dashboardResponse.data.Status === 1) {
                        ...
                        await addAccount({
                            ...
                            email: userData.Emails?.find((email: any) => email.isPrimary)?.Email ||
                                  userData.Emails?.[0]?.Email || "",
                            encryptedToken: encryptedToken,
                            profileData: {
                                isAdmin: userData.isAdmin || userData.Username === "MeetBhingradiya" || false,
...
function SignInLoading() {
    return (
        <div className="Page CENTER">
            <Modal isOpen={true} size={"md"} onClose={() => {}} isDismissable={false}>
                <ModalContent>
                    <ModalHeader className="flex flex-row items-center gap-4 justify-center">
                        <Login />
                        Sign In to Your Account
