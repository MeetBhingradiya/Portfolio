        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    >
                        Have a project in mind? Need technical consultation? Or just want to say hi?
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
                    ...
                    >
                        <Card intensity={isApple ? "strong" : undefined} elevated={!isApple}>
                            <h2
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {status.type !== "idle" && (
                                    ...
                                    >
                                        {status.type === "success" && (
                                            <CheckCircle style={{ color: "#34C759" }} />
                                        )}
                                        {status.type === "error" && (
                                            <ErrorIcon style={{ color: "#FF3B30" }} />
                                        )}
