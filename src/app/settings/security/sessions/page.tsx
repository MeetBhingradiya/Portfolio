            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        <div className="p-3 rounded-2xl" style={{ background: `${palette.accent}20` }}>
                            <Devices className="text-3xl" style={{ color: palette.accent }} />
                        </div>
                        <div>
                ...
                <div className="space-y-4">
                    {loading ? (
                        ...
                        >
                            <Devices className="text-5xl mb-3" style={{ color: palette.textTertiary }} />
                            <p className="font-semibold" style={{ color: palette.textSecondary }}>
                                No active sessions
                            </p>
                        </motion.div>
                    ) : (
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className="flex items-center gap-1.5">
                                                    <div style={{ color: palette.textSecondary, fontSize: "1rem" }}>
