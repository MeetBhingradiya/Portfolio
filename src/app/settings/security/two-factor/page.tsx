                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            ...
                            <p style={{ color: palette.textSecondary }}>Add an extra layer of security to your account</p>
                        </div>
                    </div>
                </div>
                ...
                <motion.div
                    ...
                    <div>
                        ...
                        <p
                            className="text-sm"
                            style={{ color: palette.textSecondary }}>
                            Two-factor authentication adds an additional layer of security by requiring a verification code in addition to
                            your password.
                        </p>
                    </div>
                </motion.div>
