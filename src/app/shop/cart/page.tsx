            ...
            <div className="max-w-5xl mx-auto">
                ...
                {loading ? (
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-24">
                        <ShoppingBag style={{ fontSize: 72, color: palette.textTertiary, opacity: 0.3 }} />
                        <p className="mt-4 text-xl font-bold" style={{ color: palette.textSecondary }}>
                            Your cart is empty
                        </p>
                        <Link href="/shop">
                            <motion.button
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                {items.map(item => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                {item.thumbnail
                                                    ? <img src={item.thumbnail} alt={item.productName} className="w-full h-full object-cover rounded-xl" />
                                                    : <ShoppingCart style={{ color: palette.accent, opacity: 0.5 }} />
                                                }
                                            </div>

                                            <div className="flex-1 min-w-0">
                                                <p className="font-bold text-sm" style={{ color: palette.textPrimary }}>{item.productName}</p>
                                                <p className="text-xs mt-0.5" style={{ color: palette.textSecondary }}>{item.variantName}</p>
                                                <p className="text-xs capitalize mt-0.5" style={{ color: palette.textTertiary }}>{item.productType}</p>
                                            </div>
                                            ...
                                            <div className="flex flex-col items-end gap-2 flex-shrink-0">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    >
                                                        <Remove style={{ fontSize: 14, color: palette.textSecondary }} />
                                                    </motion.button>
                                                    <span className="w-6 text-center text-sm font-bold" style={{ color: palette.textPrimary }}>
                                                        {item.quantity}
                                                    </span>
                                                    <motion.button
                                                        whileTap={{ scale: 0.9 }}
                                                        ...
                                                        style={{ background: isDark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.07)" }}
                                                    >
                                                        <Add style={{ fontSize: 14, color: palette.textSecondary }} />
                                                    </motion.button>
                                                    <motion.button
                                                        whileTap={{ scale: 0.9 }}
                                                        disabled={isUpdating}
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm" style={{ color: palette.textSecondary }}>
                            ...
                            <Link href="/shop">
                                <button className="w-full py-2.5 rounded-xl text-sm font-semibold text-center" style={{ color: palette.textSecondary }}>
                                    Continue Shopping
                                </button>
                            </Link>
                        </div>
