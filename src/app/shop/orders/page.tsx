...
import { Inventory2, CheckCircle, Schedule, LocalShipping, Cancel, Refresh, ArrowForward, Search, MoneyOff } from "@mui/icons-material";
        ...
        <div
            ...
            <div className="max-w-5xl mx-auto">
                                    ...
                                    background:
                                        (s === "All" && !statusFilter) || s === statusFilter
                                            ...
                                            : isDark
                                              ...
                                              : "rgba(0,0,0,0.05)",
                                    color: (s === "All" && !statusFilter) || s === statusFilter ? "#fff" : palette.textSecondary
                                }}>
                                {s.replace("_", " ")}
                            </motion.button>
                        ))}
                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {orders
                            .filter((o) => !search || o.orderId.toLowerCase().includes(search.toLowerCase()))
                            .map((order, i) => {
