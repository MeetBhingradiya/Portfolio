...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: "/assets/og-image.png", width: 1200, height: 630, alt: "Instagram Export Analyser" }]
    },
    twitter: {
        card: "summary_large_image",
        title: "Instagram Export Analyser | Meet Bhingradiya Tools",
        description:
            "Find unfollowers, close friends, pending requests and more from your Instagram data export — free and private.",
