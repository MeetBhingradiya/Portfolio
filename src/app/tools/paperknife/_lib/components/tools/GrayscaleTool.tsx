...
import { Palette, Lock, Loader2, ArrowRight, X } from "@/app/tools/paperknife/_lib/muiLucide";
...
export default function GrayscaleTool() {
    ...
    const ActionButton = () => (
        <button
            ...
            {isProcessing ? (
                ...
                <>
                    <Palette size={18} /> Convert to Grayscale <ArrowRight size={18} />
                </>
            )}
        </button>
    );
    ...
    return (
        <NativeToolLayout
            ...
            description="Remove colors from your PDF to save ink and storage."
                            ...
                            <>
                                <div className="text-center py-2 px-4 bg-gray-50 dark:bg-black rounded-2xl border border-gray-100 dark:border-white/5">
                                    <p className="text-xs text-gray-500 dark:text-zinc-400 leading-relaxed font-medium">
                                        This tool converts all document pages to black-and-white. Best for printing and reducing file size.
                                    </p>
                                </div>
                                <div>
