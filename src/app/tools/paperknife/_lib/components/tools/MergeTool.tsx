...
import { Plus, X, Loader2, GripVertical, Lock, RotateCw, Upload, RefreshCw, ArrowRight } from "@/app/tools/paperknife/_lib/muiLucide";
    ...
    return (
        <div
            ...
            <div
                {...attributes}
                {...listeners}
                className="p-2 cursor-grab text-rose-400 hover:text-rose-600 dark:text-rose-500/50 dark:hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors active:scale-90">
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                    <p className="font-bold text-sm truncate text-gray-900 dark:text-white group-hover:text-rose-500 transition-colors">
                        {file.file.name}
                    </p>
                    {file.isLocked && (
                        <Lock
            ...
            <div className="flex items-center gap-1">
                ...
                <button
                    onClick={() => onRemove(id)}
                    className="p-2 hover:bg-rose-500/10 rounded-full text-gray-400 hover:text-rose-500 transition-all hover:scale-110 active:scale-90">
                    <X size={18} />
                </button>
            </div>
        </div>
...
export default function MergeTool() {
    ...
    const restoreWorkspace = async () => {
        ...
        const restoredFiles = ws.files.map((f) => ({
            ...
            file: new File([f.buffer as any], f.name, {
                type: "application/pdf"
            }),
            thumbnail: undefined,
            pageCount: 0,
                        ...
                        <div className="flex items-center gap-4 text-left">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium">
                                    We saved your previous file list. Want to restore it?
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <button
                                    ...
                                    className="text-[10px] font-black uppercase text-rose-500/60 hover:text-rose-500 transition-colors font-bold">
                                    Clear All
                                </button>
                            </div>
