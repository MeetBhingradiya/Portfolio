...
import { Lock, ShieldCheck, Loader2, ArrowRight, X } from "@/app/tools/paperknife/_lib/muiLucide";
...
export default function ProtectTool() {
    ...
    return (
        <NativeToolLayout
            title="Protect PDF"
            description="Add strong encryption to your documents. Processed locally."
                ...
                <div className="max-w-md mx-auto">
                    <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] border border-gray-100 dark:border-white/5 text-center">
                        ...
                        <button
                            ...
                            className="w-full bg-rose-500 text-white p-4 rounded-2xl font-black uppercase tracking-widest text-xs">
                            {isProcessing ? "..." : "Unlock"}
                        </button>
                    </div>
                </div>
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
                        ...
                        <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-white/5 flex items-start gap-3">
                            ...
                            <p className="text-[10px] text-amber-700 dark:text-amber-400 leading-relaxed font-medium">
                                PaperKnife cannot recover forgotten passwords. Save it securely.
                            </p>
                        </div>
                        <button
                            onClick={() => {
