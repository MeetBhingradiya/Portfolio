...
import { RotateCw, Lock, RefreshCcw, Loader2, X } from "@/app/tools/paperknife/_lib/muiLucide";
...
export default function RotateTool() {
    ...
    const rotateAll = () => {
        ...
        for (let i = 1; i <= (pdfData?.pageCount || 0); i++) newRotations[i] = ((newRotations[i] || 0) + 90) % 360;
    ...
    return (
        <NativeToolLayout
            title="Rotate PDF"
            description="Tap individual pages to rotate 90 degrees."
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex gap-2">
                                <button
                                    onClick={rotateAll}
                                    className="text-[10px] font-black uppercase text-rose-500 flex items-center gap-1 font-bold">
                                    <RotateCw size={12} /> All
                                </button>
                                <button
                                    onClick={() => setRotations({})}
                                    className="text-[10px] font-black uppercase text-gray-400 flex items-center gap-1 font-bold">
                            ...
                            {Array.from({ length: pdfData.pageCount }).map((_, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="relative group cursor-pointer aspect-[3/4] rounded-xl overflow-hidden border-2 border-transparent hover:border-rose-500 transition-all bg-gray-50 dark:bg-black shadow-sm">
