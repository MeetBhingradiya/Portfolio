...
import { Loader2, Lock, Image as ImageIcon, ArrowRight } from "@/app/tools/paperknife/_lib/muiLucide";
...
export default function SignatureTool() {
    ...
    return (
        <NativeToolLayout
            title="Signature"
            description="Sign any PDF by dragging your signature image."
            ...
            {!pdfData ? (
                ...
                <div className="max-w-md mx-auto p-8 bg-white dark:bg-zinc-900 rounded-3xl text-center">
                    ...
                    <button
                        ...
                        className="w-full p-4 bg-rose-500 text-white rounded-xl">
                        Unlock
                    </button>
                </div>
            ) : (
                        ...
                        <>
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="flex-1 p-4 bg-gray-50 dark:bg-zinc-800 text-gray-900 dark:text-white border border-gray-100 dark:border-white/5 rounded-2xl font-black uppercase text-xs hover:border-rose-500 transition-all">
                                    <span className="flex items-center justify-center gap-2">
                                        <ImageIcon size={16} /> Upload Signature
                                    </span>
                                </button>
                            </div>
