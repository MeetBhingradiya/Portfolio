...
import { Lock, Unlock, Loader2, X } from "@/app/tools/paperknife/_lib/muiLucide";
...
export default function UnlockTool() {
    ...
    return (
        <NativeToolLayout
            title="Unlock PDF"
            description="Remove passwords and restrictions permanently. Processed locally."
                                ...
                                {pdfData.isLocked ? (
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-gray-50 dark:bg-black rounded-xl px-4 py-4 border border-transparent focus:border-rose-500 outline-none font-bold text-lg text-center dark:text-white"
                                            placeholder="••••••••"
                                            autoFocus
                                        />
                                    </div>
