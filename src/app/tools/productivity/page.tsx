...
function ActivityChart({
    ...
    days: { label: string; tasks: number; habits: number }[];
    isDark: boolean;
    accent: string;
}) {
...
export default function ProductivityDashboard() {
        ...
        return (
            <div className="flex flex-col items-center justify-center h-screen gap-4 p-8 text-center">
                ...
                <p
                    ...
                    Gamified tasks, habits, goals and reminders all in one place.
                </p>
            </div>
        );
    ...
    async function handleReset() {
        ...
        try {
            const r = await fetch("/api/productivity/reset", {
                method: "POST"
            });
                ...
                <div className="relative flex items-start justify-between gap-4">
                    ...
                    <div className="text-right shrink-0">
                        ...
                        <p
                            ...
                            {(levelInfo.xpForNextLevel - stats.TotalXP).toLocaleString()} XP to go
                        </p>
                    </div>
                </div>
                <div className="relative mt-4">
                    <div
                        ...
                        <motion.div
                            ...
                            style={{
                                background: `linear-gradient(90deg, ${ACCENT} 0%, #FF6B9D 100%)`
                            }}
                            initial={{ width: 0 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <motion.div
                    ...
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex gap-3 text-xs">
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <span style={{ color: palette.textTertiary }}>Tasks</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <div
                                    className="w-2 h-2 rounded-full"
                                ...
                                />
                                <span style={{ color: palette.textTertiary }}>Habits</span>
                            </div>
                        </div>
                    </div>
                    <ActivityChart
                    ...
                    <p
                        ...
                        style={{ color: palette.textTertiary }}>
                        {totalWeek} completions this week
                    </p>
                </motion.div>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    width: `${Math.min(100, (h.CurrentStreak / Math.max(h.LongestStreak, 1)) * 100)}%`,
                                                    background: h.Color ?? ACCENT
                                                }}
                                            />
                                        </div>
                                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            },
                            {
                                ...
                                href: "/tools/productivity/habits",
                                icon: <Loop />,
                                badge: habits.filter((h) => !h.completedToday).length || null
                            },
                            {
                                label: "Goals",
                            ...
                            return (
                                <div
                                    ...
                                    <span
                                        ...
                                        style={{
                                            color: today ? "#f59e0b" : palette.textTertiary
                                        }}>
                                        {today
                                            ? at.toLocaleTimeString("en", {
                                                  hour: "2-digit",
                                                  minute: "2-digit"
                                              })
                                            : at.toLocaleDateString("en", {
                                                  month: "short",
                                                  day: "numeric"
                                              })}
                                    </span>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p
                            ...
                            style={{ color: palette.textSecondary }}>
                            Permanently delete all your tasks, habits, goals and reminders. XP and level are reset to zero. This cannot be
                            undone.
                        </p>
                    </div>
                    <motion.button
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <p
                                ...
                                style={{ color: palette.textSecondary }}>
                                This will permanently delete <strong>all tasks, habits, goals and reminders</strong> and reset your XP and
                                level to zero. The reset date will be recorded in your history.
                            </p>
                            <p
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    color: palette.textPrimary,
                                    borderColor: resetInput === "RESET" ? "#ef4444" : border
                                }}
                            ...
                            <div className="flex gap-3">
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        background:
                                            resetInput === "RESET" ? "#ef4444" : isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)",
                                        color: resetInput === "RESET" ? "#fff" : palette.textTertiary
                                    }}
