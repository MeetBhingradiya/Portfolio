...
function ColorRow({ label, value, onChange, theme }: { label: string; value: string; onChange: (v: string) => void; theme: ThemeProp }) {
    const { palette, isDark, isApple } = theme;
    const inputStyle: React.CSSProperties = {
        background: isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.04)",
        color: palette.textPrimary,
...
function GradientEditor({ gradient, onChange, theme }: { gradient: Gradient; onChange: (g: Gradient) => void; theme: ThemeProp }) {
    const { palette } = theme;
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <Pill
                ...
                value={gradient.type}
                onChange={(t) => onChange({ ...gradient, type: t })}
                theme={theme}
            />
            ...
            <div
                ...
                <motion.button
                    ...
                    onClick={() =>
                        onChange({
                            ...gradient,
                            colorStops: [...gradient.colorStops, { offset: 0.5, color: "#888888" }]
                        })
                    }
                    style={{
                        padding: "3px 10px",
                ...
                <div
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            onChange({
                                ...gradient,
                                colorStops: gradient.colorStops.map((s, j) => (j === i ? { ...s, color: e.target.value } : s))
                            })
                        }
                        style={{
                            width: 32,
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            onChange({
                                ...gradient,
                                colorStops: gradient.colorStops.map((s, j) =>
                                    j === i
                                        ? {
                                              ...s,
                    ...
                    {gradient.colorStops.length > 2 && (
                        <motion.button
                            ...
                            onClick={() =>
                                onChange({
                                    ...gradient,
                                    colorStops: gradient.colorStops.filter((_, j) => j !== i)
                                })
                            }
                            style={{
                                width: 24,
...
function ColorModeSection({
    ...
    label: string;
    mode: "color" | "gradient";
    onModeChange: (m: "color" | "gradient") => void;
    color: string;
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <Pill
                label={label}
                options={["color", "gradient"] as const}
                value={mode}
            ...
            <div>
                <button
                    ...
                    <div
                        ...
                        <span
                            style={{
                                fontSize: isApple ? 14 : 16,
                                fontWeight: isApple ? 600 : 900,
                                color: palette.textPrimary
                            }}>
                            {title}
                        </span>
...
const DEFAULT_STATE: QRState = {
    ...
    dotColorMode: "color",
    dotColor: "#000000",
    dotGradient: defaultGradient(),
    dotsRoundSize: false,
    cornerSquareType: "extra-rounded",
    cornerSquareColorMode: "color",
    cornerSquareColor: "#000000",
    cornerSquareGradient: defaultGradient(),
    cornerDotType: "dot",
    cornerDotColorMode: "color",
    cornerDotColor: "#000000",
    cornerDotGradient: defaultGradient(),
    bgColorMode: "color",
    bgColor: "#ffffff",
    bgGradient: defaultGradient("#ffffff", "#f0f0f0"),
    bgRound: 0,
    imageUrl: "",
    imageSize: 0.4,
    imageMargin: 5,
    ...
    borderRound: 0,
    borderDasharray: "0",
    borderTopText: "Scan Here",
    borderBottomText: "Try Me",
    borderLeftText: "",
    borderRightText: "",
    borderTextStyle: "font: 30px sans-serif; fill: #D5B882;",
    borderInnerColor: "#000000",
    borderInnerThickness: 0,
    borderInnerDasharray: "0",
    borderOuterColor: "#000000",
    borderOuterThickness: 0,
    borderOuterDasharray: "0",
    licenseKey: ""
};
...
const DATA_TYPES: { value: DataType; label: string; icon: React.ReactNode }[] = [
    ...
    },
    {
        value: "text",
        label: "Text",
        icon: <TextFields sx={{ fontSize: 15 }} />
    },
    {
        value: "upi",
        label: "UPI Pay",
        icon: <CurrencyRupee sx={{ fontSize: 15 }} />
    },
    {
        value: "wifi",
        label: "WiFi",
        icon: <WifiIcon sx={{ fontSize: 15 }} />
    },
    {
        value: "bluetooth",
        label: "Bluetooth",
        icon: <BluetoothSearching sx={{ fontSize: 15 }} />
    },
    {
        value: "vcard",
        label: "Contact",
        icon: <ContactPage sx={{ fontSize: 15 }} />
    },
    {
        value: "email",
        label: "Email",
...
export default function QRGeneratorPage() {
    ...
    const updateNested = useCallback(<K extends keyof QRState>(field: K, patch: Partial<QRState[K]>) => {
        setState((prev) => ({
            ...prev,
            [field]: { ...(prev[field] as object), ...patch }
        }));
    }, []);
                    ...
                    qrInstance.current.applyExtension(
                        QRBorder({
                            ...
                            decorations: {
                                top: {
                                    type: "text" as const,
                                    value: state.borderTopText,
                                    style: state.borderTextStyle
                                },
                                bottom: {
                                    type: "text" as const,
                                    value: state.borderBottomText,
                                    style: state.borderTextStyle
                                },
                                left: {
                                    type: "text" as const,
                                    value: state.borderLeftText,
                                    style: state.borderTextStyle
                                },
                                right: {
                                    type: "text" as const,
                                    value: state.borderRightText,
                                    style: state.borderTextStyle
                                }
                            },
                            borderInner: {
                ...
                <div
                                ...
                                <>
                                    <div
                                        ...
                                        <Field
                                            label="UPI ID (VPA)"
                                            value={state.upi.pa}
                                            onChange={(v) => updateNested("upi", { pa: v })}
                                        ...
                                        <Field
                                            label="Payee Name"
                                            value={state.upi.pn}
                                            onChange={(v) => updateNested("upi", { pn: v })}
                            ...
                            {state.dataType === "wifi" && (
                                <>
                                    <Field
                                        ...
                                        onChange={(v) => updateNested("wifi", { ssid: v })}
                                    ...
                                    <Pill
                                        ...
                                        value={state.wifi.type}
                                        onChange={(v) => updateNested("wifi", { type: v })}
                                        theme={theme}
                                    />
                                    <Toggle
                                        label="Hidden Network"
                                        checked={state.wifi.hidden}
                                        onChange={(v) => updateNested("wifi", { hidden: v })}
                                        theme={theme}
                                    />
                                </>
                            )}
                    ...
                    <Section
                        ...
                        <div
                            ...
                            <Pill
                                label="Render Engine"
                                options={["svg", "canvas"] as const}
                                value={state.drawType}
                                onChange={(v) => update("drawType", v)}
                                theme={theme}
                            />
                            ...
                            <Toggle
                                label="Round Dot Size (smoother edges)"
                                checked={state.dotsRoundSize}
                                onChange={(v) => update("dotsRoundSize", v)}
                                theme={theme}
                            />
                            <ColorModeSection
                                label="Dots Color"
                                mode={state.dotColorMode}
                                onModeChange={(m) => update("dotColorMode", m)}
                                color={state.dotColor}
                                onColorChange={(c) => update("dotColor", c)}
                                gradient={state.dotGradient}
                                onGradientChange={(g) => update("dotGradient", g)}
                                theme={theme}
                            />
                            ...
                            <Pill
                                ...
                                options={["square", "extra-rounded", "dot"] as const}
                            ...
                            <ColorModeSection
                                ...
                                mode={state.cornerSquareColorMode}
                                onModeChange={(m) => update("cornerSquareColorMode", m)}
                                color={state.cornerSquareColor}
                                onColorChange={(c) => update("cornerSquareColor", c)}
                                gradient={state.cornerSquareGradient}
                                onGradientChange={(g) => update("cornerSquareGradient", g)}
                                theme={theme}
                            />
                            ...
                            <ColorModeSection
                                ...
                                mode={state.cornerDotColorMode}
                                onModeChange={(m) => update("cornerDotColorMode", m)}
                                color={state.cornerDotColor}
                                onColorChange={(c) => update("cornerDotColor", c)}
                                gradient={state.cornerDotGradient}
                                onGradientChange={(g) => update("cornerDotGradient", g)}
                                theme={theme}
                            />
                            ...
                            <ColorModeSection
                                label="Background"
                                mode={state.bgColorMode}
                                onModeChange={(m) => update("bgColorMode", m)}
                                color={state.bgColor}
                                onColorChange={(c) => update("bgColor", c)}
                            ...
                            <div
                                ...
                                <input
                                    ...
                                    min={0}
                                    max={100}
                                    value={Math.round(state.bgRound * 100)}
                        ...
                        <div
                            ...
                            <div
                                ...
                                <label
                                    ...
                                    Image Size: {state.imageSize.toFixed(2)}
                                </label>
                                <input
                                    type="range"
                                    min={0.1}
                            ...
                            <div
                                ...
                                <label
                                    ...
                                    Image Margin: {state.imageMargin}px
                                </label>
                                <input
                                    type="range"
                                    min={0}
                                    ...
                                    onChange={(e) => update("imageMargin", +e.target.value)}
                                    style={{ accentColor: palette.accent }}
                                />
                            </div>
                            <Toggle
                                label="Hide Background Dots Behind Image"
                                checked={state.hideBackgroundDots}
                                onChange={(v) => update("hideBackgroundDots", v)}
                                theme={theme}
                            />
                            <Toggle
                                label="Save as Blob (better cross-origin support)"
                                checked={state.saveAsBlob}
                                onChange={(v) => update("saveAsBlob", v)}
                                theme={theme}
                            />
                        </div>
                    </Section>
                    ...
                    <Section
                        id="border"
                        icon={<BorderOuter sx={{ fontSize: 18 }} />}
                            ...
                            {state.borderEnabled && (
                                <>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => update("borderThickness", +e.target.value)}
                                                    style={{
                                                        accentColor: palette.accent
                                                    }}
                                                />
                                            ...
                                            <div
                                                ...
                                                <label
                                                    ...
                                                    Corner Radius: {Math.round(state.borderRound * 100)}%
                                                </label>
                                                <input
                                                    type="range"
                                                    min={0}
                                                    max={100}
                                                    value={Math.round(state.borderRound * 100)}
                                                    onChange={(e) => update("borderRound", +e.target.value / 100)}
                                                    style={{
                                                        accentColor: palette.accent
                                                    }}
                                                />
                                            ...
                                            />
                                            <Field
                                                label="Dash Array (e.g. 0 · 4 8 · 10 5 5)"
                                                value={state.borderDasharray}
                                                onChange={(v) => update("borderDasharray", v)}
                                                placeholder="0"
                                                theme={theme}
                                            />
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <Field
                                                    label="Top"
                                                    value={state.borderTopText}
                                                    onChange={(v) => update("borderTopText", v)}
                                                ...
                                                <Field
                                                    label="Bottom"
                                                    value={state.borderBottomText}
                                                    onChange={(v) => update("borderBottomText", v)}
                                                    placeholder="Try Me"
                                                    theme={theme}
                                                />
                                            </div>
                                            <div
                                                ...
                                                <Field
                                                    label="Left"
                                                    value={state.borderLeftText}
                                                    onChange={(v) => update("borderLeftText", v)}
                                                    placeholder=""
                                                    theme={theme}
                                                />
                                                <Field
                                                    label="Right"
                                                    value={state.borderRightText}
                                                    onChange={(v) => update("borderRightText", v)}
                                                    placeholder=""
                                                    theme={theme}
                                                />
                                            </div>
                                            <Field
                                                label="Text Style (SVG CSS — applies to all sides)"
                                                value={state.borderTextStyle}
                                                onChange={(v) => update("borderTextStyle", v)}
                                                placeholder="font: 30px sans-serif; fill: #D5B882;"
                                                theme={theme}
                                            />
                                        </div>
                                    </fieldset>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    min={0}
                                                    max={20}
                                                    value={state.borderInnerThickness}
                                                    onChange={(e) => update("borderInnerThickness", +e.target.value)}
                                                    style={{
                                                        accentColor: palette.accent
                                                    }}
                                                />
                                            ...
                                            <ColorRow
                                                label="Color"
                                                value={state.borderInnerColor}
                                                onChange={(v) => update("borderInnerColor", v)}
                                                theme={theme}
                                            />
                                            <Field
                                                label="Dash Array"
                                                value={state.borderInnerDasharray}
                                                onChange={(v) => update("borderInnerDasharray", v)}
                                                placeholder="0"
                                                theme={theme}
                                            />
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input
                                                    ...
                                                    min={0}
                                                    max={20}
                                                    value={state.borderOuterThickness}
                                                    onChange={(e) => update("borderOuterThickness", +e.target.value)}
                                                    style={{
                                                        accentColor: palette.accent
                                                    }}
                                                />
                                            ...
                                            <ColorRow
                                                label="Color"
                                                value={state.borderOuterColor}
                                                onChange={(v) => update("borderOuterColor", v)}
                                                theme={theme}
                                            />
                                            <Field
                                                label="Dash Array"
                                                value={state.borderOuterDasharray}
                                                onChange={(v) => update("borderOuterDasharray", v)}
                                                placeholder="0"
                                                theme={theme}
                                            />
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <motion.button
                                            whileTap={{ scale: 0.93 }}
                                            onClick={() => update("borderEnabled", false)}
                                            style={{
                                                padding: "7px 14px",
                                                borderRadius: 999,
                                                fontSize: 11,
                        ...
                        <div
                                    ...
                                    {(["L", "M", "Q", "H"] as const).map((lvl, i) => {
                                        ...
                                        return (
                                            <motion.button
                                                key={lvl}
                                                whileTap={{ scale: 0.93 }}
                                                onClick={() => update("errorCorrection", lvl)}
                                                style={{
                                                    display: "flex",
                                                    flexDirection: "column",
                                                    alignItems: "center",
                            ...
                            <div
                                ...
                                <Field
                                    ...
                                    type="number"
                                    placeholder="400"
                                    onChange={(v) => update("width", Math.max(100, Math.min(2000, +v || 400)))}
                                    theme={theme}
                                />
                                <Field
                                    label="Height (px)"
                                    ...
                                    type="number"
                                    placeholder="400"
                                    onChange={(v) => update("height", Math.max(100, Math.min(2000, +v || 400)))}
                                    theme={theme}
                                />
                            </div>
                            <div
                            ...
                            <div
                                ...
                                <div style={{ display: "flex", gap: 8 }}>
                                    <Field
                                        ...
                                        onChange={(v) => update("licenseKey", v)}
                ...
                <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                {[
                                    {
                                        label: "Type",
                                        value: state.dataType.toUpperCase()
                                    },
                                    {
                                        label: "Size",
                                    ...
                                    {
                                        label: "Border",
                                        value: state.borderEnabled ? "On" : "Off"
                                    }
                                ].map(({ label, value }) => (
                                    <div
                                        key={label}
                    ...
                    <Card>
                        <div
                            ...
                            <Pill
                                label="Format"
                                options={["png", "svg", "jpeg", "webp"] as const}
                                value={state.fileExt}
                                onChange={(v) => update("fileExt", v)}
                                theme={theme}
                            />
                            <div style={{ display: "flex", gap: 8 }}>
                                <motion.button
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    <strong>Error Correction:</strong> L ~7% · M ~15% · Q ~25% · H ~30%. Higher levels tolerate more damage
                                    but produce denser codes.
                                </p>
                                <p
                                    style={{
                                        fontSize: 11,
