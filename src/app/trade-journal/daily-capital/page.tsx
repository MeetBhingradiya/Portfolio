...
import { ArrowBack, AddCircleOutline, ShowChart, Delete } from "@mui/icons-material";
...
export default function DailyCapitalPage() {
    ...
    const dailyReturn =
        dcStart && dcEnd && parseFloat(dcStart) > 0 ? ((parseFloat(dcEnd) - parseFloat(dcStart)) / parseFloat(dcStart)) * 100 : null;
        ...
        <div className="max-w-4xl mx-auto space-y-6 pt-6 pb-28 px-4 sm:px-6">
            ...
            <motion.div
                ...
                <p
                    ...
                    Sharpe = (avgDailyReturn − 6%/252) ÷ stdDev × √252 &nbsp;·&nbsp; requires ≥ 2 days of data.
                </p>
            </motion.div>
            ...
            <motion.div
                ...
                {dailyReturn !== null && (
                    <p
                        ...
                        <span
                            style={{
                                color: dailyReturn >= 0 ? "#22c55e" : "#ef4444",
                                fontWeight: 600
                            }}>
                            {dailyReturn >= 0 ? "+" : ""}
                            ...
                            <thead>
                                <tr
                                    ...
                                    {["Date", "Start (₹)", "End (₹)", "Net P&L", "Return %", "Notes", ""].map((h) => (
                                        <td
                                            key={h}
                                            className="pb-2 pr-3 font-semibold uppercase tracking-widest">
                                            {h}
                                        </td>
                                    ))}
                                </tr>
                                    ...
                                    return (
                                        <tr
                                            ...
                                            <td
                                                ...
                                                {pos ? "+" : ""}₹
                                                {Math.abs(e.NetPnL).toLocaleString("en-IN", {
                                            ...
                                            <td
                                                className="py-2 pr-3 max-w-[120px] truncate"
                                                style={{
                                                    color: palette.textSecondary
                                                }}>
                                                {e.Notes || "—"}
                                            ...
                                            <td className="py-2">
                                                <motion.button
                                                    ...
                                                    style={{
                                                        color: "#ef4444",
                                                        opacity: dcDeleting === e.Date ? 0.4 : 1
                                                    }}
