...
export const metadata: Metadata = {
    ...
    description:
        "19 essential trading rules framework for consistent, disciplined, and profitable trading. Complete guide covering risk management, psychology, execution, and learning strategies.",
    keywords: [
        "trading rules",
        "trading discipline",
        "risk management",
    ...
    openGraph: {
        ...
        description:
            "Essential trading rules for consistent, profitable, and disciplined trading. Master risk management, psychology, and execution.",
        type: "website",
