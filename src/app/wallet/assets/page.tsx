...
const ASSET_COLORS = ["#06b6d4", "#3b82f6", "#8b5cf6", "#ec4899", "#22c55e", "#f59e0b", "#ef4444", "#14b8a6"];
...
export default function AssetsPage() {
    ...
    const fetchAssets = useCallback(async () => {
        setLoading(true);
        const res = await fetch(`/api/wallet/assets?t=${Date.now()}`, {
            cache: "no-store"
        }).then((r) => r.json());
        if (res.success) {
    ...
    const handleDelete = async (id: string) => {
        ...
        setDeletingId(id);
        const res = await fetch(`/api/wallet/assets?id=${id}`, {
            method: "DELETE"
        }).then((r) => r.json());
                    ...
                    <LiquidGlassCard
                        ...
                        <div>
                            ...
                            <p
                                ...
                                style={{
                                    color: totalBalance >= 0 ? palette.textPrimary : "#ef4444"
                                }}>
                                ...
                                <div className="flex flex-col h-full gap-4">
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-3">
                                            {asset.Icon ? (
                                                <div
                                                    className="w-12 h-12 rounded-2xl overflow-hidden bg-white/5 border flex-shrink-0"
                                                    style={{
                                            ...
                                            <div>
                                                ...
                                                {isUpi && asset.LinkedBankName ? (
                                                    <span
                                                        className="text-[10px] font-bold uppercase px-1.5 py-0.5 rounded flex items-center gap-1 w-max mt-1"
                                                        style={{
                                                        ...
                                                        />{" "}
                                                        {asset.LinkedBankName}
                                                    </span>
                                                ) : (
                                                    <span
                                                        className="text-[10px] font-bold uppercase px-1.5 py-0.5 rounded mt-1 block w-max"
                                                        style={{
                                                            background: `${assetColor}15`,
                                                            color: assetColor
                                                        }}>
                                        ...
                                        <div className="flex opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    color: "#ef4444",
                                                    opacity: deletingId === asset.AssetID ? 0.5 : 1
                                                }}>
                                        ...
                                        {isUpi ? (
                                            ...
                                            <>
                                                <p
                                                    ...
                                                    style={{
                                                        color: asset.Balance >= 0 ? assetColor : "#ef4444"
                                                    }}>
                                                    ₹
                                                    {Math.abs(asset.Balance).toLocaleString("en-IN", {
                                                ...
                                                <div className="flex items-center justify-between mt-2">
                                                    ...
                                                    <span
                                                        ...
                                                        {asset.Balance >= asset.InitialBalance ? "+" : "−"}₹
                                                        {Math.abs(asset.Balance - asset.InitialBalance).toLocaleString("en-IN", {
                                                            maximumFractionDigits: 2
                                                        })}
                                                    </span>
                                                </div>
                            ...
                            return (
                                <motion.div
                                    ...
                                    {isApple ? (
                                        <div
                                            style={{
                                                borderTop: `2px solid ${assetColor}60`,
                                                borderRadius: "20px"
                                            }}>
                                            <LiquidGlassCard
                                                intensity="subtle"
                                                className="p-5 h-full group transition-all hover:-translate-y-1 hover:shadow-xl">
                                                {innerContent}
                                            </LiquidGlassCard>
                                        </div>
                                    ) : (
                                        <div
                                            style={{
                                                borderTop: `3px solid ${assetColor}`,
                                                borderRadius: "32px",
                                                overflow: "hidden"
                                            }}>
                        ...
                        <div className="space-y-5">
                            ...
                            {type === "UPI_APP" && (
                                <motion.div
                                    ...
                                    className="space-y-5 p-4 rounded-xl"
                                    style={{
                                    ...
                                    <div>
                                        <label
                                            className="text-xs font-bold block mb-2 uppercase tracking-wide flex items-center gap-1"
                                            style={{ color: palette.accent }}>
                                        ...
                                        <CustomSelect
                                            ...
                                            options={bankAssets.map((b) => ({
                                                value: b.AssetID,
                                                label: `${b.Name} (₹${b.Balance.toLocaleString()})`
                                            }))}
                                        ...
                                        <p
                                            ...
                                            UPI apps use the linked bank's balance automatically.
                                        </p>
                                    </div>
                                    <div>
                                        <label
                                            className="text-xs font-bold block mb-2 uppercase tracking-wide"
                                            style={{ color: palette.accent }}>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g. 9876543210@ybl, name@oksbi"
                                            ...
                                            .map((c) => (
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        boxShadow: (color || palette.accent) === c ? `0 0 0 2px ${c}` : "none",
                                                        opacity: (color || palette.accent) === c ? 1 : 0.5
                                                    }}
                                                />
                                            ))}
                                    </div>
                            ...
                            <button
                                onClick={handleSave}
                                disabled={saving || !name.trim() || (type === "UPI_APP" && !linkedAssetId)}
                                ...
                                style={{
                                    ...
                                    opacity: !name.trim() || (type === "UPI_APP" && !linkedAssetId) ? 0.5 : 1
                                }}>
