...
export default function ContactsPage() {
    ...
    const fetchContacts = useCallback(async () => {
        ...
        const res = await fetch(`/api/wallet/contacts?${params}`, {
            cache: "no-store"
        }).then((r) => r.json());
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <motion.div
                    ...
                    {isApple ? (
                        <LiquidGlassCard
                            intensity="subtle"
                            className="p-5 flex flex-col justify-center border-l-4 border-green-500">
                ...
                <motion.div
                    ...
                    {isApple ? (
                        <LiquidGlassCard
                            intensity="subtle"
                            className="p-5 flex flex-col justify-center border-l-4 border-red-500">
                            <div className="flex items-center gap-2 mb-2">
            ...
            <div
                ...
                style={{
                    background: isApple ? (isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.03)") : inputBg,
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className="flex opacity-0 group-hover:opacity-100 transition-opacity gap-1">
                                            ...
                                            <button
                                                ...
                                                disabled={deletingId === c.ContactID}
                                                className="p-1.5 hover:bg-red-500/10 rounded-lg transition-colors"
                                                style={{
                                                    color: "#ef4444",
                                                    opacity: deletingId === c.ContactID ? 0.5 : 1
                                                }}>
                        ...
                        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                            {[
                                ...
                                },
                                {
                                    ...
                                    value: phones,
                                    set: setPhones,
                                    ph: "Mobile number(s) comma separated",
                                    type: "text"
                                },
                                {
                                    label: "Email(s)",
                                    value: emails,
                                    set: setEmails,
                                    ph: "Email address(es) comma separated",
                                    type: "text"
                                },
                                {
                                    label: "Pending Collection ₹",
                                    value: pendingCollections,
                                    set: setPendingCollections,
                                    ph: "0",
                                    type: "number"
                                },
                                {
