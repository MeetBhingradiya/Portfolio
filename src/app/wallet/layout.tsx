...
const NAV_ITEMS = [
    ...
    { label: "New Transaction", href: "/wallet/new",        icon: <AddCircleOutline /> },
        ...
        <div className="flex flex-col h-full p-4 gap-1">
            ...
            <div className="flex items-center gap-3 px-3 py-4 mb-2">
                ...
                <div>
                    ...
                    <p className="text-xs" style={{ color: palette.textSecondary }}>Manager</p>
                </div>
            </div>
                    ...
                    return (
                        <Link key={item.href} href={item.href} onClick={() => setMobileOpen(false)}>
                            <motion.div
                                ...
                                whileHover={{ scale: 1.02, background: `${palette.accent}10` }}
                                whileTap={{ scale: 0.98 }}
                            >
