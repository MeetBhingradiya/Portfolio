    ...
    return (
        <div className="p-6 max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold" style={{ color: palette.textPrimary }}>New Transaction</h1>
                    <p className="text-sm" style={{ color: palette.textSecondary }}>Record income, expense, or transfer</p>
                </div>
            </div>
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
                ...
                >
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-5 gap-2">
                            {CATEGORIES.map(cat => (
                                ...
                                >
                                    ...
                                    <span className="truncate w-full text-center" style={{ fontSize: 9, letterSpacing: '0.05em' }}>
                                        {cat.replace(/_/g, " ")}
                                    </span>
                                </motion.button>
                            ))}
                    ...
                    <div className="flex gap-5 px-1 py-2">
                        <label className="flex items-center gap-2.5 cursor-pointer text-sm font-semibold tracking-wide" style={{ color: palette.textSecondary }}>
                            <input
                                type="checkbox"
                                checked={isHidden}
